...
// General
pub static MOA_TOKEN_ID: &[u8] = b"MOA-123456";
    ...
    SimpleLockObjBuilder: 'static + Copy + Fn() -> energy_factory::ContractObj<DebugApi>,
{
    pub fn new(
        ...
        b_mock.set_dcdt_balance(&first_user, MOA_TOKEN_ID, &user_balance);
    ...
    PairObjBuilder: 'static + Copy + Fn() -> pair::ContractObj<DebugApi>,
{
    ...
    b_mock
        .execute_tx(owner, &pair_wrapper, &rust_zero, |sc| {
            let first_token_id = managed_token_id!(MOA_TOKEN_ID);
    ...
    FarmLockedObjBuilder: 'static + Copy + Fn() -> farm_with_locked_rewards::ContractObj<DebugApi>,
{
    ...
    b_mock
        .execute_tx(owner, &farm_wrapper, &rust_zero, |sc| {
            let reward_token_id = managed_token_id!(MOA_TOKEN_ID);
            let farming_token_id = managed_token_id!(MOA_TOKEN_ID);
