...
use dharitri_sc::types::{Address, BigInt, DcdtLocalRole, ManagedAddress, MultiValueEncoded};
    ...
    EnergyFactoryBuilder: 'static + Copy + Fn() -> energy_factory::ContractObj<DebugApi>,
{
    pub fn new(farm_builder: FarmObjBuilder, energy_factory_builder: EnergyFactoryBuilder) -> Self {
        ...
        b_mock.set_dcdt_balance(&owner_addr, REWARD_TOKEN_ID, &TOTAL_REWARDS_AMOUNT.into());
        b_mock
    ...
    pub fn stake_farm_for_other_user(
        ...
        self.b_mock
            .execute_dcdt_multi_transfer(broker, &self.farm_wrapper, &payments, |sc| {
    ...
    pub fn claim_rewards(
        ...
        self.b_mock
            .check_dcdt_balance(user, REWARD_TOKEN_ID, expected_user_reward_token_balance);
        self.b_mock
            .check_dcdt_balance(user, FARMING_TOKEN_ID, expected_user_farming_token_balance);
    }
