use crate::{address_h256_to_drtrs, denali_to_drtrs_address, network_response, Interactor};
use log::info;
...
fn contract_call_to_tx_data(
    contract_call: &dharitri_sc_scenario::imports::ContractCallWithRewa<StaticApi, ()>,
) -> String {
