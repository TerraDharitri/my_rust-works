...
use numbat_wasm::abi::EndpointLocationAbi;
...
fn write_wasm_src_lib(contract_metadata: &ContractMetadata) {
    ...
    let full_macro_name = match contract_metadata.location {
        EndpointLocationAbi::MainContract => "numbat_wasm_node::wasm_endpoints!",
        EndpointLocationAbi::ViewContract => "numbat_wasm_node::external_view_wasm_endpoints!",
    };
