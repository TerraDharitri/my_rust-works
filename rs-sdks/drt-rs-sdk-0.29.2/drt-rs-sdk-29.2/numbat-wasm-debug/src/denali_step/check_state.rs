use denali::model::{
    AddressKey, BytesValue, CheckDcdt, CheckDcdtData, CheckDcdtInstance, CheckDcdtInstances,
    CheckDcdtMap, CheckStorage, CheckValue, Checkable,
};
        ...
        CheckDcdtMap::Equal(contents) => {
            for (key, expected_value) in contents.contents.iter() {
                ...
                match expected_value {
                    CheckDcdt::Short(expected_balance_bytes) => {
