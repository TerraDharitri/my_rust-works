...
use dharitri_sc::{
    ...
    types::RewaOrDcdtTokenIdentifier,
};
...
const PRICE_AGGREGATOR_PATH_EXPR: &str = "drtsc:../output/dharitri-sc-price-aggregator.drtsc.json";
...
type PriceAggregatorContract = ContractInfo<dharitri_sc_price_aggregator::Proxy<StaticApi>>;
