...
mod call_async {
    ...
    use numbat_wasm::api::{ErrorApi, LogApi};
    ...
    impl<BigUint: BigUintApi> numbat_codec::TopEncode for CallbackData<BigUint> {
        fn top_encode<O: numbat_codec::TopEncodeOutput>(
            &self,
            output: O,
        ) -> core::result::Result<(), numbat_codec::EncodeError> {
            let mut buffer = numbat_codec::Vec::<u8>::new();
            let dest = &mut buffer;
            numbat_codec::NestedEncode::dep_encode(&self.callback_name, dest)?;
            numbat_codec::NestedEncode::dep_encode(&self.token_identifier, dest)?;
            numbat_codec::NestedEncode::dep_encode(&self.token_nonce, dest)?;
            numbat_codec::NestedEncode::dep_encode(&self.token_amount, dest)?;
            numbat_codec::NestedEncode::dep_encode(&self.args, dest)?;
        ...
        fn top_encode_or_exit<O: numbat_codec::TopEncodeOutput, ExitCtx: Clone>(
            ...
            let mut buffer = numbat_codec::Vec::<u8>::new();
            let dest = &mut buffer;
            numbat_codec::NestedEncode::dep_encode_or_exit(
                &self.callback_name,
                dest,
                c.clone(),
                exit,
            ...
            numbat_codec::NestedEncode::dep_encode_or_exit(&self.args, dest, c.clone(), exit);
            output.set_slice_u8(&buffer[..]);
        }
    }
    impl<BigUint: BigUintApi> numbat_codec::TopDecode for CallbackData<BigUint> {
        fn top_decode<I: numbat_codec::TopDecodeInput>(
            top_input: I,
        ) -> core::result::Result<Self, numbat_codec::DecodeError> {
            let bytes = top_input.into_boxed_slice_u8();
            let input = &mut &*bytes;
            let result = CallbackData {
                callback_name: <BoxedBytes as numbat_codec::NestedDecode>::dep_decode(input)?,
                token_identifier: <TokenIdentifier as numbat_codec::NestedDecode>::dep_decode(
                    input,
                )?,
                token_nonce: <u64 as numbat_codec::NestedDecode>::dep_decode(input)?,
                token_amount: <BigUint as numbat_codec::NestedDecode>::dep_decode(input)?,
                args: <Vec<BoxedBytes> as numbat_codec::NestedDecode>::dep_decode(input)?,
            };
            if !input.is_empty() {
        ...
        fn top_decode_or_exit<I: numbat_codec::TopDecodeInput, ExitCtx: Clone>(
            ...
            let input = &mut &*bytes;
            let result = CallbackData {
                callback_name: <BoxedBytes as numbat_codec::NestedDecode>::dep_decode_or_exit(
                    input,
                    c.clone(),
                    exit,
                ),
                token_identifier:
                    <TokenIdentifier as numbat_codec::NestedDecode>::dep_decode_or_exit(
                        input,
                        c.clone(),
                        exit,
                    ),
                token_nonce: <u64 as numbat_codec::NestedDecode>::dep_decode_or_exit(
                    input,
                    c.clone(),
                    exit,
                ),
                token_amount: <BigUint as numbat_codec::NestedDecode>::dep_decode_or_exit(
                    input,
                    c.clone(),
                    exit,
                ),
                args: <Vec<BoxedBytes> as numbat_codec::NestedDecode>::dep_decode_or_exit(
                    input,
                    c.clone(),
                    exit,
                ),
    ...
    impl<BigUint: BigUintApi> numbat_wasm::abi::TypeAbi for CallbackData<BigUint> {
        fn type_name() -> numbat_wasm::String {
            "CallbackData".into()
        }
        fn provide_type_descriptions<TDC: numbat_wasm::abi::TypeDescriptionContainer>(
            accumulator: &mut TDC,
        ) {
    ...
    pub trait ForwarderAsyncCallModule: numbat_wasm::api::ContractBase + Sized
    where
        ...
        C: AutoImpl,
    {
        ...
        fn callback_data(&self) -> VecMapper<Self::Storage, CallbackData<Self::BigUint>> {
            ...
            < VecMapper < Self :: Storage , CallbackData < Self :: BigUint > > as numbat_wasm :: storage :: mappers :: StorageMapper < Self :: Storage > > :: new (self . get_storage_raw () , numbat_wasm :: types :: BoxedBytes :: from (key))
        }
        fn callbacks(&self) -> self::CallbackProxyObj<Self::SendApi> {
    ...
    pub trait EndpointWrappers:
        numbat_wasm::api::ContractPrivateApi + ForwarderAsyncCallModule
    where
        Self::BigUint: numbat_wasm::api::BigUintApi,
        for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
        for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
        ...
        for<'b> Self::BigInt: core::ops::RemAssign<&'b Self::BigInt>,
    {
        ...
        fn call_forward_async_accept_funds(&self) {
            ...
            let to = numbat_wasm::load_single_arg::<Self::ArgumentApi, Address>(
                self.argument_api(),
                0i32,
                ArgId::from(&b"to"[..]),
            );
        ...
        fn call_forward_async_retrieve_funds(&self) {
            ...
            numbat_wasm::api::EndpointArgumentApi::check_num_arguments(&self.argument_api(), 4i32);
            let to = numbat_wasm::load_single_arg::<Self::ArgumentApi, Address>(
                self.argument_api(),
                0i32,
                ArgId::from(&b"to"[..]),
            );
            let token = numbat_wasm::load_single_arg::<Self::ArgumentApi, TokenIdentifier>(
                self.argument_api(),
                1i32,
                ArgId::from(&b"token"[..]),
            );
            let token_nonce = numbat_wasm::load_single_arg::<Self::ArgumentApi, u64>(
                self.argument_api(),
                2i32,
                ArgId::from(&b"token_nonce"[..]),
            );
            let amount = numbat_wasm::load_single_arg::<Self::ArgumentApi, Self::BigUint>(
                self.argument_api(),
                3i32,
                ArgId::from(&b"amount"[..]),
            );
        ...
        fn call_send_funds_twice(&self) {
            self.call_value().check_not_payable();
            numbat_wasm::api::EndpointArgumentApi::check_num_arguments(&self.argument_api(), 3i32);
            let to = numbat_wasm::load_single_arg::<Self::ArgumentApi, Address>(
                self.argument_api(),
                0i32,
                ArgId::from(&b"to"[..]),
            );
            let token_identifier = numbat_wasm::load_single_arg::<Self::ArgumentApi, TokenIdentifier>(
                self.argument_api(),
                1i32,
        ...
        fn call_callback_data_at_index(&self) {
            self.call_value().check_not_payable();
            numbat_wasm::api::EndpointArgumentApi::check_num_arguments(&self.argument_api(), 1i32);
            let index = numbat_wasm::load_single_arg::<Self::ArgumentApi, usize>(
                self.argument_api(),
                0i32,
                ArgId::from(&b"index"[..]),
            );
        ...
        fn callback_selector<'a>(
            &self,
            mut ___cb_data_deserializer___: numbat_wasm::hex_call_data::HexCallDataDeserializer<'a>,
        ) -> numbat_wasm::types::CallbackSelectorResult<'a> {
            ...
            match ___cb_data_deserializer___.get_func_name() {
                ...
                [115u8, 101u8, 110u8, 100u8, 95u8, 102u8, 117u8, 110u8, 100u8, 115u8, 95u8, 116u8, 119u8, 105u8, 99u8, 101u8, 95u8, 99u8, 97u8, 108u8, 108u8, 98u8, 97u8, 99u8, 107u8] =>
                {
                    let mut ___cb_closure_loader___ =
                        CallDataArgLoader::new(___cb_data_deserializer___, self.error_api());
                    let to: &Address = &numbat_wasm::load_dyn_arg(
                        &mut ___cb_closure_loader___,
                        ArgId::from(&b"to"[..]),
                    );
                    let token_identifier: &TokenIdentifier = &numbat_wasm::load_dyn_arg(
                        &mut ___cb_closure_loader___,
                        ArgId::from(&b"token_identifier"[..]),
                    );
                    let cb_amount: &Self::BigUint = &numbat_wasm::load_dyn_arg(
                        &mut ___cb_closure_loader___,
        ...
        fn callback(&self) {
            ...
            let ___cb_data_raw___ = numbat_wasm::api::StorageReadApi::storage_load_boxed_bytes(
                &self.get_storage_raw(),
                &___tx_hash___.as_bytes(),
            );
            numbat_wasm::api::StorageWriteApi::storage_store_slice_u8(
                &self.get_storage_raw(),
                &___tx_hash___.as_bytes(),
                &[],
            );
            let mut ___cb_data_deserializer___ =
                numbat_wasm::hex_call_data::HexCallDataDeserializer::new(
    ...
    impl numbat_wasm::api::ContractAbiProvider for AbiProvider {
        ...
        fn abi() -> numbat_wasm::abi::ContractAbi {
            let mut contract_abi = numbat_wasm :: abi :: ContractAbi { docs : & [] , name : "ForwarderAsyncCallModule" , constructor : None , endpoints : Vec :: new () , type_descriptions : < numbat_wasm :: abi :: TypeDescriptionContainerImpl as numbat_wasm :: abi :: TypeDescriptionContainer > :: new () , } ;
    ...
    pub trait ProxyTrait: numbat_wasm::api::ProxyObjApi + Sized {
        ...
        fn forward_async_accept_funds(
            ...
            Self::SendApi,
            <AsyncCall<Self::SendApi> as numbat_wasm::io::EndpointResult>::DecodeAs,
        > {
            ...
            let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
                ...
                payment,
                token_nonce,
                numbat_wasm::types::BoxedBytes::from(&b"forward_async_accept_funds"[..]),
            );
            numbat_wasm::io::serialize_contract_call_arg(
                to,
        ...
        > {
            ...
            let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
                ...
                payment,
                ___nonce___,
                numbat_wasm::types::BoxedBytes::from(
        ...
        > {
            ...
            let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                numbat_wasm::types::BoxedBytes::from(&b"forward_async_retrieve_funds"[..]),
            );
            numbat_wasm::io::serialize_contract_call_arg(
                to,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        > {
            ...
            let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                numbat_wasm::types::BoxedBytes::from(&b"send_funds_twice"[..]),
            );
            numbat_wasm::io::serialize_contract_call_arg(
                to,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        #[allow(clippy::too_many_arguments)]        fn callback_data (self) -> numbat_wasm :: types :: ContractCall < Self :: SendApi , < VecMapper < Self :: Storage , CallbackData < Self :: BigUint > > as numbat_wasm :: io :: EndpointResult > :: DecodeAs >{
            let (___api___, ___address___, ___token___, ___payment___, ___nonce___) =
                self.into_fields();
            let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
                ___api___.clone(),
                ...
                ___payment___,
                ___nonce___,
                numbat_wasm::types::BoxedBytes::from(&b"callback_data"[..]),
            );
            ___contract_call___
        }
        #[allow(clippy::too_many_arguments)]
        fn callback_data_at_index(
            ...
            <MultiResult5<
                ...
                Self::BigUint,
                MultiResultVec<BoxedBytes>,
            > as numbat_wasm::io::EndpointResult>::DecodeAs,
        > {
            let (___api___, ___address___, ___token___, ___payment___, ___nonce___) =
                self.into_fields();
            let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                numbat_wasm::types::BoxedBytes::from(&b"callback_data_at_index"[..]),
            );
            numbat_wasm::io::serialize_contract_call_arg(
                index,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        > {
            ...
            let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                numbat_wasm::types::BoxedBytes::from(&b"clear_callback_data"[..]),
            );
            ___contract_call___
        }
    }
    ...
    pub trait CallbackProxy: numbat_wasm::api::CallbackProxyObjApi + Sized {
        fn retrieve_funds_callback(self) -> numbat_wasm::types::CallbackCall {
        ...
        fn send_funds_twice_callback(
            ...
            token_identifier: &TokenIdentifier,
            cb_amount: &Self::BigUint,
        ) -> numbat_wasm::types::CallbackCall {
            let ___api___ = self.into_api();
            let mut ___closure_arg_buffer___ = numbat_wasm::types::ArgBuffer::new();
            numbat_wasm::io::serialize_contract_call_arg(
                to,
...
mod call_sync {
    ...
    use numbat_wasm::{Box, Vec};
    use vault::ProxyTrait as _;
    pub trait ForwarderSyncCallModule: numbat_wasm::api::ContractBase + Sized
    where
        Self::BigUint: numbat_wasm::api::BigUintApi,
        for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
        for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
        ...
        C: AutoImpl,
    {
        ...
        fn execute_on_dest_context_result_event(&self, result: &[BoxedBytes]) {
            ...
            let ___data_bytes___ =
                numbat_wasm::log_util::serialize_log_data(result, self.log_api_raw());
            self.log_api_raw()
    ...
    pub trait EndpointWrappers:
        numbat_wasm::api::ContractPrivateApi + ForwarderSyncCallModule
    where
        Self::BigUint: numbat_wasm::api::BigUintApi,
        for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
        for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
        ...
        for<'b> Self::BigInt: core::ops::RemAssign<&'b Self::BigInt>,
    {
        ...
        fn call_echo_arguments_sync(&self) {
            ...
            let to: Address =
                numbat_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"to"[..]));
            let args: VarArgs<BoxedBytes> =
                numbat_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"args"[..]));
        ...
        fn call_echo_arguments_sync_range(&self) {
            ...
            let to: Address =
                numbat_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"to"[..]));
            let start: usize =
                numbat_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"start"[..]));
            let end: usize =
                numbat_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"end"[..]));
            let args: VarArgs<BoxedBytes> =
                numbat_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"args"[..]));
            ___arg_loader.assert_no_more_args();
    ...
    impl numbat_wasm::api::ContractAbiProvider for AbiProvider {
        ...
        type SendApi = numbat_wasm::api::uncallable::UncallableApi;
        fn abi() -> numbat_wasm::abi::ContractAbi {
            let mut contract_abi = numbat_wasm :: abi :: ContractAbi { docs : & [] , name : "ForwarderSyncCallModule" , constructor : None , endpoints : Vec :: new () , type_descriptions : < numbat_wasm :: abi :: TypeDescriptionContainerImpl as numbat_wasm :: abi :: TypeDescriptionContainer > :: new () , } ;
            let mut endpoint_abi = numbat_wasm::abi::EndpointAbi {
                docs: &[],
    ...
    pub trait ProxyTrait: numbat_wasm::api::ProxyObjApi + Sized {
        ...
        > {
            ...
            let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                numbat_wasm::types::BoxedBytes::from(&b"echo_arguments_sync"[..]),
            );
            numbat_wasm::io::serialize_contract_call_arg(
                to,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        > {
            ...
            let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                numbat_wasm::types::BoxedBytes::from(&b"echo_arguments_sync_range"[..]),
            );
            numbat_wasm::io::serialize_contract_call_arg(
                to,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        > {
            ...
            let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                numbat_wasm::types::BoxedBytes::from(&b"echo_arguments_sync_twice"[..]),
            );
            numbat_wasm::io::serialize_contract_call_arg(
                to,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        > {
            ...
            let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
                ...
                payment,
                token_nonce,
                numbat_wasm::types::BoxedBytes::from(&b"forward_sync_accept_funds"[..]),
            );
            numbat_wasm::io::serialize_contract_call_arg(
                to,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        fn forward_sync_accept_funds_then_read(
            ...
            Self::SendApi,
            <usize as numbat_wasm::io::EndpointResult>::DecodeAs,
        > {
            let (___api___, ___address___, ___token___, ___payment___, ___nonce___) =
                self.into_fields();
            let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
                ...
                payment,
                token_nonce,
                numbat_wasm::types::BoxedBytes::from(&b"forward_sync_accept_funds_then_read"[..]),
            );
            numbat_wasm::io::serialize_contract_call_arg(
                to,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        > {
            ...
            let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                numbat_wasm::types::BoxedBytes::from(&b"forward_sync_retrieve_funds"[..]),
            );
            numbat_wasm::io::serialize_contract_call_arg(
                to,
                ___contract_call___.get_mut_arg_buffer(),
...
mod call_transf_exec {
    ...
    use numbat_wasm::{Box, Vec};
    use vault::ProxyTrait as _;
    pub trait ForwarderTransferExecuteModule: numbat_wasm::api::ContractBase + Sized
    where
        Self::BigUint: numbat_wasm::api::BigUintApi,
        for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
        for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
    ...
    pub trait EndpointWrappers:
        numbat_wasm::api::ContractPrivateApi + ForwarderTransferExecuteModule
    where
        Self::BigUint: numbat_wasm::api::BigUintApi,
        for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
        for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
    ...
    impl numbat_wasm::api::ContractAbiProvider for AbiProvider {
        ...
        type SendApi = numbat_wasm::api::uncallable::UncallableApi;
        fn abi() -> numbat_wasm::abi::ContractAbi {
            let mut contract_abi = numbat_wasm :: abi :: ContractAbi { docs : & [] , name : "ForwarderTransferExecuteModule" , constructor : None , endpoints : Vec :: new () , type_descriptions : < numbat_wasm :: abi :: TypeDescriptionContainerImpl as numbat_wasm :: abi :: TypeDescriptionContainer > :: new () , } ;
            let mut endpoint_abi = numbat_wasm::abi::EndpointAbi {
                docs: &[],
    ...
    pub trait ProxyTrait: numbat_wasm::api::ProxyObjApi + Sized {
        ...
        > {
            ...
            let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
                ...
                payment,
                token_nonce,
                numbat_wasm::types::BoxedBytes::from(&b"forward_transf_exec_accept_funds"[..]),
            );
            numbat_wasm::io::serialize_contract_call_arg(
                to,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        #[allow(clippy::too_many_arguments)]        fn forward_transf_exec_accept_funds_return_values (self , to : Address , token : TokenIdentifier , payment : Self :: BigUint , token_nonce : u64) -> numbat_wasm :: types :: ContractCall < Self :: SendApi , < MultiResult4 < u64 , u64 , Self :: BigUint , TokenIdentifier > as numbat_wasm :: io :: EndpointResult > :: DecodeAs >{
            let (___api___, ___address___, ___token___, ___payment___, ___nonce___) =
                self.into_fields();
            let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
                ___api___.clone(),
...
mod contract_change_owner {
    ...
    use numbat_wasm::{Box, Vec};
    use vault::ProxyTrait as _;
    pub trait ChangeOwnerModule: numbat_wasm::api::ContractBase + Sized
    where
        Self::BigUint: numbat_wasm::api::BigUintApi,
        for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
        for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
    ...
    pub trait EndpointWrappers: numbat_wasm::api::ContractPrivateApi + ChangeOwnerModule
    where
        Self::BigUint: numbat_wasm::api::BigUintApi,
        for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
        for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
        ...
        for<'b> Self::BigInt: core::ops::RemAssign<&'b Self::BigInt>,
    {
        ...
        fn call_change_owner(&self) {
            self.call_value().check_not_payable();
            numbat_wasm::api::EndpointArgumentApi::check_num_arguments(&self.argument_api(), 2i32);
            let child_sc_address = numbat_wasm::load_single_arg::<Self::ArgumentApi, Address>(
                self.argument_api(),
                0i32,
                ArgId::from(&b"child_sc_address"[..]),
            );
            let new_owner = numbat_wasm::load_single_arg::<Self::ArgumentApi, Address>(
                self.argument_api(),
                1i32,
    ...
    impl numbat_wasm::api::ContractAbiProvider for AbiProvider {
        ...
        type SendApi = numbat_wasm::api::uncallable::UncallableApi;
        fn abi() -> numbat_wasm::abi::ContractAbi {
            let mut contract_abi = numbat_wasm :: abi :: ContractAbi { docs : & [] , name : "ChangeOwnerModule" , constructor : None , endpoints : Vec :: new () , type_descriptions : < numbat_wasm :: abi :: TypeDescriptionContainerImpl as numbat_wasm :: abi :: TypeDescriptionContainer > :: new () , } ;
            let mut endpoint_abi = numbat_wasm::abi::EndpointAbi {
                docs: &[],
    ...
    pub trait ProxyTrait: numbat_wasm::api::ProxyObjApi + Sized {
        ...
        fn change_owner(
            ...
            Self::SendApi,
            <Address as numbat_wasm::io::EndpointResult>::DecodeAs,
        > {
            let (___api___, ___address___, ___token___, ___payment___, ___nonce___) =
                self.into_fields();
            let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                numbat_wasm::types::BoxedBytes::from(&b"changeOwnerAddress"[..]),
            );
            numbat_wasm::io::serialize_contract_call_arg(
                child_sc_address,
                ___contract_call___.get_mut_arg_buffer(),
...
mod contract_deploy {
    ...
    use numbat_wasm::{Box, Vec};
    use vault::ProxyTrait as _;
    pub trait DeployContractModule: numbat_wasm::api::ContractBase + Sized
    where
        Self::BigUint: numbat_wasm::api::BigUintApi,
        for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
        for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
    ...
    pub trait EndpointWrappers:
        numbat_wasm::api::ContractPrivateApi + DeployContractModule
    where
        Self::BigUint: numbat_wasm::api::BigUintApi,
        for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
        for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
        ...
        for<'b> Self::BigInt: core::ops::RemAssign<&'b Self::BigInt>,
    {
        ...
        fn call_deploy_contract(&self) {
            self.call_value().check_not_payable();
            numbat_wasm::api::EndpointArgumentApi::check_num_arguments(&self.argument_api(), 1i32);
            let code = numbat_wasm::load_single_arg::<Self::ArgumentApi, BoxedBytes>(
                self.argument_api(),
                0i32,
                ArgId::from(&b"code"[..]),
            );
        ...
        fn call_deploy_from_source(&self) {
            self.call_value().check_not_payable();
            let mut ___arg_loader = EndpointDynArgLoader::new(self.argument_api());
            let source_contract_address: Address = numbat_wasm::load_dyn_arg(
                &mut ___arg_loader,
                ArgId::from(&b"source_contract_address"[..]),
            );
            let arguments: VarArgs<BoxedBytes> =
                numbat_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"arguments"[..]));
            ___arg_loader.assert_no_more_args();
    ...
    impl numbat_wasm::api::ContractAbiProvider for AbiProvider {
        ...
        type SendApi = numbat_wasm::api::uncallable::UncallableApi;
        fn abi() -> numbat_wasm::abi::ContractAbi {
            let mut contract_abi = numbat_wasm :: abi :: ContractAbi { docs : & [] , name : "DeployContractModule" , constructor : None , endpoints : Vec :: new () , type_descriptions : < numbat_wasm :: abi :: TypeDescriptionContainerImpl as numbat_wasm :: abi :: TypeDescriptionContainer > :: new () , } ;
            let mut endpoint_abi = numbat_wasm::abi::EndpointAbi {
                docs: &[],
    ...
    pub trait ProxyTrait: numbat_wasm::api::ProxyObjApi + Sized {
        ...
        fn deploy_contract(
            ...
            Self::SendApi,
            <SCResult<Address> as numbat_wasm::io::EndpointResult>::DecodeAs,
        > {
            let (___api___, ___address___, ___token___, ___payment___, ___nonce___) =
                self.into_fields();
            let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                numbat_wasm::types::BoxedBytes::from(&b"deploy_contract"[..]),
            );
            numbat_wasm::io::serialize_contract_call_arg(
                code,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        > {
            ...
            let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                numbat_wasm::types::BoxedBytes::from(&b"deployFromSource"[..]),
            );
            numbat_wasm::io::serialize_contract_call_arg(
                source_contract_address,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        fn deploy_two_contracts(
            ...
            Self::SendApi,
            <SCResult<MultiResult2<Address, Address>> as numbat_wasm::io::EndpointResult>::DecodeAs,
        > {
            let (___api___, ___address___, ___token___, ___payment___, ___nonce___) =
                self.into_fields();
            let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                numbat_wasm::types::BoxedBytes::from(&b"deploy_two_contracts"[..]),
            );
            numbat_wasm::io::serialize_contract_call_arg(
                code,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        fn deploy_vault(
            ...
            Self::SendApi,
            <Option<Address> as numbat_wasm::io::EndpointResult>::DecodeAs,
        > {
            let (___api___, ___address___, ___token___, ___payment___, ___nonce___) =
                self.into_fields();
            let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                numbat_wasm::types::BoxedBytes::from(&b"deploy_vault"[..]),
            );
            numbat_wasm::io::serialize_contract_call_arg(
                code,
                ___contract_call___.get_mut_arg_buffer(),
...
mod contract_update {
    ...
    use numbat_wasm::{non_zero_usize, only_owner, require, sc_error};
    use numbat_wasm::{Box, Vec};
    pub trait UpgradeContractModule: numbat_wasm::api::ContractBase + Sized
    where
        Self::BigUint: numbat_wasm::api::BigUintApi,
        for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
        for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
    ...
    pub trait EndpointWrappers:
        numbat_wasm::api::ContractPrivateApi + UpgradeContractModule
    where
        Self::BigUint: numbat_wasm::api::BigUintApi,
        for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
        for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
        ...
        for<'b> Self::BigInt: core::ops::RemAssign<&'b Self::BigInt>,
    {
        ...
        fn call_upgrade_child_contract(&self) {
            self.call_value().check_not_payable();
            let mut ___arg_loader = EndpointDynArgLoader::new(self.argument_api());
            let child_sc_address: Address = numbat_wasm::load_dyn_arg(
                &mut ___arg_loader,
                ArgId::from(&b"child_sc_address"[..]),
            );
            let new_code: BoxedBytes =
                numbat_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"new_code"[..]));
            let arguments: VarArgs<BoxedBytes> =
                numbat_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"arguments"[..]));
            ___arg_loader.assert_no_more_args();
    ...
    impl numbat_wasm::api::ContractAbiProvider for AbiProvider {
        ...
        type SendApi = numbat_wasm::api::uncallable::UncallableApi;
        fn abi() -> numbat_wasm::abi::ContractAbi {
            let mut contract_abi = numbat_wasm :: abi :: ContractAbi { docs : & [] , name : "UpgradeContractModule" , constructor : None , endpoints : Vec :: new () , type_descriptions : < numbat_wasm :: abi :: TypeDescriptionContainerImpl as numbat_wasm :: abi :: TypeDescriptionContainer > :: new () , } ;
            let mut endpoint_abi = numbat_wasm::abi::EndpointAbi {
                docs: &[],
    ...
    pub trait ProxyTrait: numbat_wasm::api::ProxyObjApi + Sized {
        ...
        > {
            ...
            let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                numbat_wasm::types::BoxedBytes::from(&b"upgradeChildContract"[..]),
            );
            numbat_wasm::io::serialize_contract_call_arg(
                child_sc_address,
                ___contract_call___.get_mut_arg_buffer(),
...
mod dcdt {
    ...
    use numbat_wasm::{Box, Vec};
    use super::storage;
    pub trait ForwarderDcdtModule:
        numbat_wasm::api::ContractBase + Sized + storage::ForwarderStorageModule
    where
        Self::BigUint: numbat_wasm::api::BigUintApi,
        for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
        for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
    ...
    pub trait AutoImpl: numbat_wasm::api::ContractBase {}
    impl<C> ForwarderDcdtModule for C
    where
        Self::BigUint: numbat_wasm::api::BigUintApi,
        for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
        for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
    ...
    pub trait EndpointWrappers:
        numbat_wasm::api::ContractPrivateApi + ForwarderDcdtModule + storage::EndpointWrappers
    where
        Self::BigUint: numbat_wasm::api::BigUintApi,
        for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
        for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
    ...
    {
        #[inline]
        fn call_get_fungible_dcdt_balance(&self) {
            self.call_value().check_not_payable();
            numbat_wasm::api::EndpointArgumentApi::check_num_arguments(&self.argument_api(), 1i32);
            let token_identifier = numbat_wasm::load_single_arg::<Self::ArgumentApi, TokenIdentifier>(
                self.argument_api(),
            ...
            let result = self.get_fungible_dcdt_balance(&token_identifier);
            numbat_wasm::io::EndpointResult::finish(&result, self.finish_api());
        }
        #[inline]
        fn call_send_dcdt(&self) {
            self.call_value().check_not_payable();
            let mut ___arg_loader = EndpointDynArgLoader::new(self.argument_api());
            let to: &Address =
                &numbat_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"to"[..]));
            let token_id: TokenIdentifier =
                numbat_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"token_id"[..]));
            let amount: &Self::BigUint =
                &numbat_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"amount"[..]));
            let opt_data: OptionalArg<BoxedBytes> =
                numbat_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"opt_data"[..]));
            ___arg_loader.assert_no_more_args();
            self.send_dcdt(&to, token_id, &amount, opt_data);
        }
        #[inline]
        fn call_send_dcdt_twice(&self) {
            self.call_value().check_not_payable();
            let mut ___arg_loader = EndpointDynArgLoader::new(self.argument_api());
            let to: &Address =
                &numbat_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"to"[..]));
            let token_id: TokenIdentifier =
                numbat_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"token_id"[..]));
            let amount_first_time: &Self::BigUint = &numbat_wasm::load_dyn_arg(
                &mut ___arg_loader,
                ArgId::from(&b"amount_first_time"[..]),
            );
            let amount_second_time: &Self::BigUint = &numbat_wasm::load_dyn_arg(
                &mut ___arg_loader,
        ...
        fn call_issue_fungible_token(&self) {
            let issue_cost = self.call_value().require_rewa();
            numbat_wasm::api::EndpointArgumentApi::check_num_arguments(&self.argument_api(), 3i32);
            let token_display_name = numbat_wasm::load_single_arg::<Self::ArgumentApi, BoxedBytes>(
                self.argument_api(),
                0i32,
                ArgId::from(&b"token_display_name"[..]),
            );
            let token_ticker = numbat_wasm::load_single_arg::<Self::ArgumentApi, BoxedBytes>(
                self.argument_api(),
                1i32,
                ArgId::from(&b"token_ticker"[..]),
            );
            let initial_supply = numbat_wasm::load_single_arg::<Self::ArgumentApi, Self::BigUint>(
                self.argument_api(),
                2i32,
        ...
        fn call(&self, fn_name: &[u8]) -> bool {
            if match fn_name {
                ...
                {
                    self.call_get_fungible_dcdt_balance();
                    true
                }
        ...
        fn callback_selector<'a>(
            ...
            match ___cb_data_deserializer___.get_func_name() {
                ...
                [101u8, 115u8, 100u8, 116u8, 95u8, 105u8, 115u8, 115u8, 117u8, 101u8, 95u8, 99u8, 97u8, 108u8, 108u8, 98u8, 97u8, 99u8, 107u8] =>
                {
                    ...
                    let mut ___cb_closure_loader___ =
                        CallDataArgLoader::new(___cb_data_deserializer___, self.error_api());
                    let caller: &Address = &numbat_wasm::load_dyn_arg(
                        &mut ___cb_closure_loader___,
                        ArgId::from(&b"caller"[..]),
                    );
                    let result: AsyncCallResult<()> = numbat_wasm::load_dyn_arg(
    ...
    impl numbat_wasm::api::ContractAbiProvider for AbiProvider {
        ...
        type SendApi = numbat_wasm::api::uncallable::UncallableApi;
        fn abi() -> numbat_wasm::abi::ContractAbi {
            let mut contract_abi = numbat_wasm :: abi :: ContractAbi { docs : & [] , name : "ForwarderDcdtModule" , constructor : None , endpoints : Vec :: new () , type_descriptions : < numbat_wasm :: abi :: TypeDescriptionContainerImpl as numbat_wasm :: abi :: TypeDescriptionContainer > :: new () , } ;
            let mut endpoint_abi = numbat_wasm::abi::EndpointAbi {
                docs: &[],
                name: "getFungibleDcdtBalance",
                only_owner: false,
                payable_in_tokens: &[],
                inputs: Vec::new(),
                outputs: Vec::new(),
    ...
    pub trait ProxyTrait: numbat_wasm::api::ProxyObjApi + Sized + storage::ProxyTrait {
        #[allow(clippy::too_many_arguments)]
        fn get_fungible_dcdt_balance(
            self,
            token_identifier: &TokenIdentifier,
        ) -> numbat_wasm::types::ContractCall<
            Self::SendApi,
            <Self::BigUint as numbat_wasm::io::EndpointResult>::DecodeAs,
        > {
            let (___api___, ___address___, ___token___, ___payment___, ___nonce___) =
                self.into_fields();
            let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                numbat_wasm::types::BoxedBytes::from(&b"getFungibleDcdtBalance"[..]),
            );
            numbat_wasm::io::serialize_contract_call_arg(
                token_identifier,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        > {
            ...
            let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                numbat_wasm::types::BoxedBytes::from(&b"send_dcdt"[..]),
            );
            numbat_wasm::io::serialize_contract_call_arg(
                to,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        > {
            ...
            let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                numbat_wasm::types::BoxedBytes::from(&b"send_dcdt_twice"[..]),
            );
            numbat_wasm::io::serialize_contract_call_arg(
                to,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        > {
            ...
            let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
                ...
                issue_cost,
                ___nonce___,
                numbat_wasm::types::BoxedBytes::from(&b"issue_fungible_token"[..]),
            );
            numbat_wasm::io::serialize_contract_call_arg(
                token_display_name,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        > {
            ...
            let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                numbat_wasm::types::BoxedBytes::from(&b"local_mint"[..]),
            );
            numbat_wasm::io::serialize_contract_call_arg(
                token_identifier,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        > {
            ...
            let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                numbat_wasm::types::BoxedBytes::from(&b"local_burn"[..]),
            );
            numbat_wasm::io::serialize_contract_call_arg(
                token_identifier,
                ___contract_call___.get_mut_arg_buffer(),
    ...
    pub trait CallbackProxy: numbat_wasm::api::CallbackProxyObjApi + Sized {
        fn dcdt_issue_callback(self, caller: &Address) -> numbat_wasm::types::CallbackCall {
            let ___api___ = self.into_api();
            let mut ___closure_arg_buffer___ = numbat_wasm::types::ArgBuffer::new();
            numbat_wasm::io::serialize_contract_call_arg(
                caller,
...
mod nft {
    ...
    impl numbat_codec::TopEncode for Color {
        fn top_encode<O: numbat_codec::TopEncodeOutput>(
            &self,
            output: O,
        ) -> core::result::Result<(), numbat_codec::EncodeError> {
            let mut buffer = numbat_codec::Vec::<u8>::new();
            let dest = &mut buffer;
            numbat_codec::NestedEncode::dep_encode(&self.r, dest)?;
            numbat_codec::NestedEncode::dep_encode(&self.g, dest)?;
            numbat_codec::NestedEncode::dep_encode(&self.b, dest)?;
            output.set_slice_u8(&buffer[..]);
            core::result::Result::Ok(())
        }
        fn top_encode_or_exit<O: numbat_codec::TopEncodeOutput, ExitCtx: Clone>(
            ...
            let mut buffer = numbat_codec::Vec::<u8>::new();
            let dest = &mut buffer;
            numbat_codec::NestedEncode::dep_encode_or_exit(&self.r, dest, c.clone(), exit);
            numbat_codec::NestedEncode::dep_encode_or_exit(&self.g, dest, c.clone(), exit);
            numbat_codec::NestedEncode::dep_encode_or_exit(&self.b, dest, c.clone(), exit);
            output.set_slice_u8(&buffer[..]);
        }
    }
    impl numbat_codec::TopDecode for Color {
        fn top_decode<I: numbat_codec::TopDecodeInput>(
            top_input: I,
        ) -> core::result::Result<Self, numbat_codec::DecodeError> {
            let bytes = top_input.into_boxed_slice_u8();
            let input = &mut &*bytes;
            let result = Color {
                r: <u8 as numbat_codec::NestedDecode>::dep_decode(input)?,
                g: <u8 as numbat_codec::NestedDecode>::dep_decode(input)?,
                b: <u8 as numbat_codec::NestedDecode>::dep_decode(input)?,
            };
            if !input.is_empty() {
                return core::result::Result::Err(numbat_codec::DecodeError::INPUT_TOO_LONG);
            }
        ...
        fn top_decode_or_exit<I: numbat_codec::TopDecodeInput, ExitCtx: Clone>(
            ...
            let input = &mut &*bytes;
            let result = Color {
                r: <u8 as numbat_codec::NestedDecode>::dep_decode_or_exit(input, c.clone(), exit),
                g: <u8 as numbat_codec::NestedDecode>::dep_decode_or_exit(input, c.clone(), exit),
                b: <u8 as numbat_codec::NestedDecode>::dep_decode_or_exit(input, c.clone(), exit),
            };
            if !input.is_empty() {
                exit(c, numbat_codec::DecodeError::INPUT_TOO_LONG);
            }
    ...
    impl numbat_wasm::abi::TypeAbi for Color {
        fn type_name() -> numbat_wasm::String {
            "Color".into()
        }
        fn provide_type_descriptions<TDC: numbat_wasm::abi::TypeDescriptionContainer>(
    ...
    pub trait EndpointWrappers:
        numbat_wasm::api::ContractPrivateApi + ForwarderNftModule + storage::EndpointWrappers
    where
        Self::BigUint: numbat_wasm::api::BigUintApi,
        for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
        for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
        ...
        for<'b> Self::BigInt: core::ops::RemAssign<&'b Self::BigInt>,
    {
        ...
        fn call_get_nft_balance(&self) {
            ...
            let nonce = numbat_wasm::load_single_arg::<Self::ArgumentApi, u64>(
                self.argument_api(),
                1i32,
                ArgId::from(&b"nonce"[..]),
            );
        ...
        fn call_buy_nft(&self) {
            numbat_wasm::api::EndpointArgumentApi::check_num_arguments(&self.argument_api(), 3i32);
            let nft_id = numbat_wasm::load_single_arg::<Self::ArgumentApi, TokenIdentifier>(
                self.argument_api(),
                0i32,
                ArgId::from(&b"nft_id"[..]),
            );
            let nft_nonce = numbat_wasm::load_single_arg::<Self::ArgumentApi, u64>(
                self.argument_api(),
                1i32,
                ArgId::from(&b"nft_nonce"[..]),
            );
            let nft_amount = numbat_wasm::load_single_arg::<Self::ArgumentApi, Self::BigUint>(
                self.argument_api(),
                2i32,
        ...
        fn call_nft_create(&self) {
            self.call_value().check_not_payable();
            numbat_wasm::api::EndpointArgumentApi::check_num_arguments(&self.argument_api(), 7i32);
            let token_identifier = numbat_wasm::load_single_arg::<Self::ArgumentApi, TokenIdentifier>(
                self.argument_api(),
                0i32,
                ArgId::from(&b"token_identifier"[..]),
            ...
            let name = numbat_wasm::load_single_arg::<Self::ArgumentApi, BoxedBytes>(
                self.argument_api(),
                2i32,
                ArgId::from(&b"name"[..]),
            );
            let royalties = numbat_wasm::load_single_arg::<Self::ArgumentApi, Self::BigUint>(
                self.argument_api(),
                3i32,
                ArgId::from(&b"royalties"[..]),
            );
            let hash = numbat_wasm::load_single_arg::<Self::ArgumentApi, BoxedBytes>(
                self.argument_api(),
                4i32,
                ArgId::from(&b"hash"[..]),
            );
            let color = numbat_wasm::load_single_arg::<Self::ArgumentApi, Color>(
                self.argument_api(),
                5i32,
                ArgId::from(&b"color"[..]),
            );
            let uri = numbat_wasm::load_single_arg::<Self::ArgumentApi, BoxedBytes>(
                self.argument_api(),
                6i32,
                ArgId::from(&b"uri"[..]),
            );
        ...
        fn call_transfer_nft_via_async_call(&self) {
            self.call_value().check_not_payable();
            numbat_wasm::api::EndpointArgumentApi::check_num_arguments(&self.argument_api(), 5i32);
            let to = numbat_wasm::load_single_arg::<Self::ArgumentApi, Address>(
                self.argument_api(),
                0i32,
                ArgId::from(&b"to"[..]),
            ...
            let data = numbat_wasm::load_single_arg::<Self::ArgumentApi, BoxedBytes>(
                self.argument_api(),
                4i32,
                ArgId::from(&b"data"[..]),
            );
        ...
        fn call_transfer_nft_and_execute(&self) {
            ...
            let nonce: u64 =
                numbat_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"nonce"[..]));
            let amount: Self::BigUint =
                numbat_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"amount"[..]));
            let function: BoxedBytes =
                numbat_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"function"[..]));
            let arguments: VarArgs<BoxedBytes> =
                numbat_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"arguments"[..]));
            ___arg_loader.assert_no_more_args();
        ...
        fn call_create_and_send(&self) {
            self.call_value().check_not_payable();
            numbat_wasm::api::EndpointArgumentApi::check_num_arguments(&self.argument_api(), 8i32);
            let to = numbat_wasm::load_single_arg::<Self::ArgumentApi, Address>(
                self.argument_api(),
                0i32,
                ArgId::from(&b"to"[..]),
        ...
        fn callback_selector<'a>(
            ...
            match ___cb_data_deserializer___.get_func_name() {
                ...
                [110u8, 102u8, 116u8, 95u8, 105u8, 115u8, 115u8, 117u8, 101u8, 95u8, 99u8, 97u8, 108u8, 108u8, 98u8, 97u8, 99u8, 107u8] =>
                {
                    ...
                    let result: AsyncCallResult<TokenIdentifier> = numbat_wasm::load_dyn_arg(
                        &mut ___call_result_loader___,
                        ArgId::from(&b"result"[..]),
                    );
                    ___cb_closure_loader___.assert_no_more_args();
    ...
    impl numbat_wasm::api::ContractAbiProvider for AbiProvider {
        ...
        type SendApi = numbat_wasm::api::uncallable::UncallableApi;
        fn abi() -> numbat_wasm::abi::ContractAbi {
            let mut contract_abi = numbat_wasm :: abi :: ContractAbi { docs : & [] , name : "ForwarderNftModule" , constructor : None , endpoints : Vec :: new () , type_descriptions : < numbat_wasm :: abi :: TypeDescriptionContainerImpl as numbat_wasm :: abi :: TypeDescriptionContainer > :: new () , } ;
            let mut endpoint_abi = numbat_wasm::abi::EndpointAbi {
                docs: &[],
    ...
    pub trait ProxyTrait: numbat_wasm::api::ProxyObjApi + Sized + storage::ProxyTrait {
        ...
        > {
            ...
            let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                numbat_wasm::types::BoxedBytes::from(&b"get_nft_balance"[..]),
            );
            numbat_wasm::io::serialize_contract_call_arg(
                token_identifier,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        > {
            ...
            let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                numbat_wasm::types::BoxedBytes::from(&b"buy_nft"[..]),
            );
            numbat_wasm::io::serialize_contract_call_arg(
                nft_id,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        > {
            ...
            let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
                ...
                issue_cost,
                ___nonce___,
                numbat_wasm::types::BoxedBytes::from(&b"nft_issue"[..]),
            );
            numbat_wasm::io::serialize_contract_call_arg(
                token_display_name,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        fn nft_create(
            ...
            Self::SendApi,
            <u64 as numbat_wasm::io::EndpointResult>::DecodeAs,
        > {
            let (___api___, ___address___, ___token___, ___payment___, ___nonce___) =
                self.into_fields();
            let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                numbat_wasm::types::BoxedBytes::from(&b"nft_create"[..]),
            );
            numbat_wasm::io::serialize_contract_call_arg(
                token_identifier,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        > {
            ...
            let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                numbat_wasm::types::BoxedBytes::from(&b"nft_add_quantity"[..]),
            );
            numbat_wasm::io::serialize_contract_call_arg(
                token_identifier,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        > {
            ...
            let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                numbat_wasm::types::BoxedBytes::from(&b"nft_burn"[..]),
            );
            numbat_wasm::io::serialize_contract_call_arg(
                token_identifier,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        > {
            ...
            let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                numbat_wasm::types::BoxedBytes::from(&b"transfer_nft_via_async_call"[..]),
            );
            numbat_wasm::io::serialize_contract_call_arg(
                to,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        > {
            ...
            let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                numbat_wasm::types::BoxedBytes::from(&b"transfer_nft_and_execute"[..]),
            );
            numbat_wasm::io::serialize_contract_call_arg(
                to,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        > {
            ...
            let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                numbat_wasm::types::BoxedBytes::from(&b"create_and_send"[..]),
            );
            numbat_wasm::io::serialize_contract_call_arg(
                to,
                ___contract_call___.get_mut_arg_buffer(),
    ...
    pub trait CallbackProxy: numbat_wasm::api::CallbackProxyObjApi + Sized {
        fn nft_issue_callback(self, caller: &Address) -> numbat_wasm::types::CallbackCall {
            let ___api___ = self.into_api();
            let mut ___closure_arg_buffer___ = numbat_wasm::types::ArgBuffer::new();
            numbat_wasm::io::serialize_contract_call_arg(
                caller,
...
mod roles {
    ...
    pub trait EndpointWrappers:
        numbat_wasm::api::ContractPrivateApi + ForwarderRolesModule + storage::EndpointWrappers
    where
        Self::BigUint: numbat_wasm::api::BigUintApi,
        for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
        for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
        ...
        for<'b> Self::BigInt: core::ops::RemAssign<&'b Self::BigInt>,
    {
        ...
        fn call_set_local_roles(&self) {
            ...
            let mut ___arg_loader = EndpointDynArgLoader::new(self.argument_api());
            let address: Address =
                numbat_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"address"[..]));
            let token_identifier: TokenIdentifier = numbat_wasm::load_dyn_arg(
                &mut ___arg_loader,
                ArgId::from(&b"token_identifier"[..]),
            );
            let roles: VarArgs<DcdtLocalRole> =
                numbat_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"roles"[..]));
            ___arg_loader.assert_no_more_args();
    ...
    impl numbat_wasm::api::ContractAbiProvider for AbiProvider {
        ...
        type SendApi = numbat_wasm::api::uncallable::UncallableApi;
        fn abi() -> numbat_wasm::abi::ContractAbi {
            let mut contract_abi = numbat_wasm :: abi :: ContractAbi { docs : & [] , name : "ForwarderRolesModule" , constructor : None , endpoints : Vec :: new () , type_descriptions : < numbat_wasm :: abi :: TypeDescriptionContainerImpl as numbat_wasm :: abi :: TypeDescriptionContainer > :: new () , } ;
            let mut endpoint_abi = numbat_wasm::abi::EndpointAbi {
                docs: &[],
                name: "setLocalRoles",
                only_owner: false,
            ...
            endpoint_abi.add_input::<TokenIdentifier>("token_identifier");
            contract_abi.add_type_descriptions::<TokenIdentifier>();
            endpoint_abi.add_input::<VarArgs<DcdtLocalRole>>("roles");
            contract_abi.add_type_descriptions::<VarArgs<DcdtLocalRole>>();
            endpoint_abi.add_output::<AsyncCall<Self::SendApi>>(&[]);
            contract_abi.add_type_descriptions::<AsyncCall<Self::SendApi>>();
            contract_abi.endpoints.push(endpoint_abi);
            let mut endpoint_abi = numbat_wasm::abi::EndpointAbi {
    ...
    pub trait ProxyTrait: numbat_wasm::api::ProxyObjApi + Sized + storage::ProxyTrait {
        ...
        > {
            ...
            let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                numbat_wasm::types::BoxedBytes::from(&b"setLocalRoles"[..]),
            );
            numbat_wasm::io::serialize_contract_call_arg(
                address,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        > {
            ...
            let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                numbat_wasm::types::BoxedBytes::from(&b"unsetLocalRoles"[..]),
            );
            numbat_wasm::io::serialize_contract_call_arg(
                address,
                ___contract_call___.get_mut_arg_buffer(),
    ...
    pub trait CallbackProxy: numbat_wasm::api::CallbackProxyObjApi + Sized {
        fn change_roles_callback(self) -> numbat_wasm::types::CallbackCall {
            let ___api___ = self.into_api();
            let mut ___closure_arg_buffer___ = numbat_wasm::types::ArgBuffer::new();
            numbat_wasm::types::CallbackCall::from_arg_buffer(
...
mod sft {
    ...
    pub trait EndpointWrappers:
        numbat_wasm::api::ContractPrivateApi + ForwarderSftModule + storage::EndpointWrappers
    where
        Self::BigUint: numbat_wasm::api::BigUintApi,
        for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
        for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
    ...
    impl numbat_wasm::api::ContractAbiProvider for AbiProvider {
        ...
        type SendApi = numbat_wasm::api::uncallable::UncallableApi;
        fn abi() -> numbat_wasm::abi::ContractAbi {
            let mut contract_abi = numbat_wasm :: abi :: ContractAbi { docs : & [] , name : "ForwarderSftModule" , constructor : None , endpoints : Vec :: new () , type_descriptions : < numbat_wasm :: abi :: TypeDescriptionContainerImpl as numbat_wasm :: abi :: TypeDescriptionContainer > :: new () , } ;
            let mut endpoint_abi = numbat_wasm::abi::EndpointAbi {
                docs: &[],
                name: "sft_issue",
                only_owner: false,
    ...
    pub trait ProxyTrait: numbat_wasm::api::ProxyObjApi + Sized + storage::ProxyTrait {
        ...
        > {
            ...
            let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
                ...
                issue_cost,
                ___nonce___,
                numbat_wasm::types::BoxedBytes::from(&b"sft_issue"[..]),
            );
            numbat_wasm::io::serialize_contract_call_arg(
                token_display_name,
                ___contract_call___.get_mut_arg_buffer(),
    ...
    pub trait CallbackProxy: numbat_wasm::api::CallbackProxyObjApi + Sized {
        fn sft_issue_callback(self, caller: &Address) -> numbat_wasm::types::CallbackCall {
            let ___api___ = self.into_api();
            let mut ___closure_arg_buffer___ = numbat_wasm::types::ArgBuffer::new();
            numbat_wasm::io::serialize_contract_call_arg(
                caller,
...
mod storage {
    ...
    use numbat_wasm::{non_zero_usize, only_owner, require, sc_error};
    use numbat_wasm::{Box, Vec};
    pub trait ForwarderStorageModule: numbat_wasm::api::ContractBase + Sized
    where
        Self::BigUint: numbat_wasm::api::BigUintApi,
        for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
        for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
        ...
        C: AutoImpl,
    {
        fn last_issued_token(&self) -> SingleValueMapper<Self::Storage, TokenIdentifier> {
            ...
            < SingleValueMapper < Self :: Storage , TokenIdentifier > as numbat_wasm :: storage :: mappers :: StorageMapper < Self :: Storage > > :: new (self . get_storage_raw () , numbat_wasm :: types :: BoxedBytes :: from (key))
        }
        fn last_error_message(&self) -> SingleValueMapper<Self::Storage, BoxedBytes> {
            let key: &'static [u8] = b"lastErrorMessage";
            < SingleValueMapper < Self :: Storage , BoxedBytes > as numbat_wasm :: storage :: mappers :: StorageMapper < Self :: Storage > > :: new (self . get_storage_raw () , numbat_wasm :: types :: BoxedBytes :: from (key))
        }
    }
    pub trait EndpointWrappers:
        numbat_wasm::api::ContractPrivateApi + ForwarderStorageModule
    where
        Self::BigUint: numbat_wasm::api::BigUintApi,
        for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
        for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
    ...
    impl numbat_wasm::api::ContractAbiProvider for AbiProvider {
        ...
        type SendApi = numbat_wasm::api::uncallable::UncallableApi;
        fn abi() -> numbat_wasm::abi::ContractAbi {
            let mut contract_abi = numbat_wasm :: abi :: ContractAbi { docs : & [] , name : "ForwarderStorageModule" , constructor : None , endpoints : Vec :: new () , type_descriptions : < numbat_wasm :: abi :: TypeDescriptionContainerImpl as numbat_wasm :: abi :: TypeDescriptionContainer > :: new () , } ;
            let mut endpoint_abi = numbat_wasm::abi::EndpointAbi {
                docs: &[],
    ...
    pub trait ProxyTrait: numbat_wasm::api::ProxyObjApi + Sized {
        #[allow(clippy::too_many_arguments)]        fn last_issued_token (self) -> numbat_wasm :: types :: ContractCall < Self :: SendApi , < SingleValueMapper < Self :: Storage , TokenIdentifier > as numbat_wasm :: io :: EndpointResult > :: DecodeAs >{
            let (___api___, ___address___, ___token___, ___payment___, ___nonce___) =
                self.into_fields();
            let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
                ___api___.clone(),
                ...
                ___payment___,
                ___nonce___,
                numbat_wasm::types::BoxedBytes::from(&b"lastIssuedToken"[..]),
            );
            ___contract_call___
        }
        #[allow(clippy::too_many_arguments)]        fn last_error_message (self) -> numbat_wasm :: types :: ContractCall < Self :: SendApi , < SingleValueMapper < Self :: Storage , BoxedBytes > as numbat_wasm :: io :: EndpointResult > :: DecodeAs >{
            let (___api___, ___address___, ___token___, ___payment___, ___nonce___) =
                self.into_fields();
            let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
                ___api___.clone(),
                ...
                ___payment___,
                ___nonce___,
                numbat_wasm::types::BoxedBytes::from(&b"lastErrorMessage"[..]),
            );
            ___contract_call___
        }
    }
...
{
    fn init(&self) {}
    fn send_rewa(&self, to: &Address, amount: &Self::BigUint, opt_data: OptionalArg<BoxedBytes>) {
        let data = match &opt_data {
            OptionalArg::Some(data) => data.as_slice(),
            OptionalArg::None => &[],
        };
    ...
    fn accept_rewa_transfer_nft(
        ...
        if (!(nft_amount != 0)) {
            return numbat_wasm::types::SCResult::Err(numbat_wasm::types::SCError::from(
                "Cannot transfer zero amount",
            ))
            .into();
        };
        SCResult::from_result(self.send().direct_dcdt_nft_execute(
            &self.blockchain().get_caller(),
            &nft_id,
            nft_nonce,
            &nft_amount,
    ...
    fn accept_anything_transfer_nft(
        ...
        let balance = self.blockchain().get_dcdt_balance(
            &self.blockchain().get_sc_address(),
            &nft_id,
            nft_nonce,
        );
    ...
    fn accept_rewa_check_annotations_call_value(
        &self,
        ...
        let (call_value_payment_amount, call_value_payment_token) =
            self.call_value().payment_token_pair();
        let call_value_payment_nonce = self.call_value().dcdt_token_nonce();
        if (!(call_value_payment_token == TokenIdentifier::rewa())) {
            return numbat_wasm::types::SCResult::Err(numbat_wasm::types::SCError::from(
                "Call value payment token is not REWA",
            ))
            .into();
        };
        if (!(annotation_payment_token == TokenIdentifier::rewa())) {
            return numbat_wasm::types::SCResult::Err(numbat_wasm::types::SCError::from(
                "Annotation payment token is not REWA",
            ))
            .into();
        };
    ...
    for<'b> Self::BigInt: core::ops::RemAssign<&'b Self::BigInt>,
{
    ...
    #[inline]
    fn call_send_rewa(&self) {
        self.call_value().check_not_payable();
        let mut ___arg_loader = EndpointDynArgLoader::new(self.argument_api());
        let to: &Address = &numbat_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"to"[..]));
        let amount: &Self::BigUint =
            &numbat_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"amount"[..]));
        let opt_data: OptionalArg<BoxedBytes> =
            numbat_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"opt_data"[..]));
        ___arg_loader.assert_no_more_args();
        self.send_rewa(&to, &amount, opt_data);
    }
    #[inline]
    fn call_accept_rewa_transfer_nft(&self) {
        let _ = self.call_value().require_rewa();
        numbat_wasm::api::EndpointArgumentApi::check_num_arguments(&self.argument_api(), 3i32);
        let nft_id = numbat_wasm::load_single_arg::<Self::ArgumentApi, TokenIdentifier>(
            self.argument_api(),
            0i32,
        ...
        let result = self.accept_rewa_transfer_nft(nft_id, nft_nonce, nft_amount);
        numbat_wasm::io::EndpointResult::finish(&result, self.finish_api());
    }
    #[inline]
    ...
    fn call_accept_anything_with_payable_annotations_transfer_nft(&self) {
        ...
        let _payment_nonce = self.call_value().dcdt_token_nonce();
        numbat_wasm::api::EndpointArgumentApi::check_num_arguments(&self.argument_api(), 3i32);
        let nft_id = numbat_wasm::load_single_arg::<Self::ArgumentApi, TokenIdentifier>(
            self.argument_api(),
            0i32,
    ...
    #[inline]
    fn call_accept_rewa_check_annotations_call_value(&self) {
        let annotation_payment_amount = self.call_value().require_rewa();
        let annotation_payment_token = TokenIdentifier::rewa();
        let annotation_payment_nonce = 0u64;
        numbat_wasm::api::EndpointArgumentApi::check_num_arguments(&self.argument_api(), 0i32);
        let result = self.accept_rewa_check_annotations_call_value(
    ...
    fn call_accept_anything_check_annotations_call_value(&self) {
        let (annotation_payment_amount, annotation_payment_token) =
            self.call_value().payment_token_pair();
        let annotation_payment_nonce = self.call_value().dcdt_token_nonce();
        numbat_wasm::api::EndpointArgumentApi::check_num_arguments(&self.argument_api(), 0i32);
    ...
    fn call(&self, fn_name: &[u8]) -> bool {
        if match fn_name {
            ...
            {
                self.call_accept_rewa_transfer_nft();
                true
            }
            ...
            {
                self.call_accept_rewa_check_annotations_call_value();
                true
            }
        ...
        if dcdt::EndpointWrappers::call(self, fn_name) {
            return true;
        }
    ...
    fn callback_selector<'a>(
        ...
        match dcdt::EndpointWrappers::callback_selector(self, ___cb_data_deserializer___) {
            numbat_wasm::types::CallbackSelectorResult::Processed => {
                return numbat_wasm::types::CallbackSelectorResult::Processed;
            }
            numbat_wasm::types::CallbackSelectorResult::NotProcessed(recovered_deser) => {
    ...
    fn callback(&self) {
        ...
        let mut ___cb_data_deserializer___ =
            numbat_wasm::hex_call_data::HexCallDataDeserializer::new(___cb_data_raw___.as_slice());
        if let numbat_wasm::types::CallbackSelectorResult::NotProcessed(_) =
            self::EndpointWrappers::callback_selector(self, ___cb_data_deserializer___)
        {
            self.error_api().signal_error(err_msg::CALLBACK_BAD_FUNC);
...
impl numbat_wasm::api::ContractAbiProvider for AbiProvider {
    ...
    type SendApi = numbat_wasm::api::uncallable::UncallableApi;
    fn abi() -> numbat_wasm::abi::ContractAbi {
        let mut contract_abi = numbat_wasm :: abi :: ContractAbi { docs : & ["Test contract for investigating contract calls."] , name : "Forwarder" , constructor : None , endpoints : Vec :: new () , type_descriptions : < numbat_wasm :: abi :: TypeDescriptionContainerImpl as numbat_wasm :: abi :: TypeDescriptionContainer > :: new () , } ;
        let mut endpoint_abi = numbat_wasm::abi::EndpointAbi {
            docs: &[],
            name: "init",
            only_owner: false,
        ...
        let mut endpoint_abi = numbat_wasm::abi::EndpointAbi {
            docs: &[],
            name: "accept_rewa_check_annotations_call_value",
            only_owner: false,
            payable_in_tokens: &["REWA"],
            inputs: Vec::new(),
            outputs: Vec::new(),
        ...
        contract_abi.endpoints.push(endpoint_abi);
        contract_abi
            .coalesce(<call_sync::AbiProvider as numbat_wasm::api::ContractAbiProvider>::abi());
        contract_abi
            .coalesce(<call_async::AbiProvider as numbat_wasm::api::ContractAbiProvider>::abi());
        contract_abi.coalesce(
            <call_transf_exec::AbiProvider as numbat_wasm::api::ContractAbiProvider>::abi(),
        );
        contract_abi.coalesce(
            <contract_change_owner::AbiProvider as numbat_wasm::api::ContractAbiProvider>::abi(),
        );
        contract_abi.coalesce(
            <contract_deploy::AbiProvider as numbat_wasm::api::ContractAbiProvider>::abi(),
        );
        contract_abi.coalesce(
            <contract_update::AbiProvider as numbat_wasm::api::ContractAbiProvider>::abi(),
        );
        contract_abi.coalesce(<dcdt::AbiProvider as numbat_wasm::api::ContractAbiProvider>::abi());
        contract_abi.coalesce(<sft::AbiProvider as numbat_wasm::api::ContractAbiProvider>::abi());
        contract_abi.coalesce(<nft::AbiProvider as numbat_wasm::api::ContractAbiProvider>::abi());
        contract_abi.coalesce(<roles::AbiProvider as numbat_wasm::api::ContractAbiProvider>::abi());
        contract_abi
            .coalesce(<storage::AbiProvider as numbat_wasm::api::ContractAbiProvider>::abi());
        contract_abi
    }
}
pub struct ContractObj<A: numbat_wasm::api::ContractBase> {
...
impl<A> dcdt::AutoImpl for ContractObj<A> where
    A: numbat_wasm::api::ContractBase
        + numbat_wasm::api::ErrorApi
        + numbat_wasm::api::EndpointArgumentApi
        + numbat_wasm::api::EndpointFinishApi
...
impl<A> dcdt::EndpointWrappers for ContractObj<A>
where
    Self::BigUint: numbat_wasm::api::BigUintApi,
    for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
    for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
...
{
    #[allow(clippy::too_many_arguments)]
    fn init(self) -> numbat_wasm::types::ContractDeploy<Self::SendApi> {
        let (___api___, _, _, ___payment___, _) = self.into_fields();
        let mut ___contract_deploy___ =
            numbat_wasm::types::new_contract_deploy(___api___.clone(), ___payment___);
    ...
    > {
        ...
        let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
            ...
            ___payment___,
            ___nonce___,
            numbat_wasm::types::BoxedBytes::from(&b"send_rewa"[..]),
        );
        numbat_wasm::io::serialize_contract_call_arg(
            to,
            ___contract_call___.get_mut_arg_buffer(),
    ...
    fn accept_rewa_transfer_nft(
        ...
        Self::SendApi,
        <SCResult<()> as numbat_wasm::io::EndpointResult>::DecodeAs,
    > {
        let (___api___, ___address___, ___token___, ___payment___, ___nonce___) =
            self.into_fields();
        let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
            ...
            ___payment___,
            ___nonce___,
            numbat_wasm::types::BoxedBytes::from(&b"accept_rewa_transfer_nft"[..]),
        );
        numbat_wasm::io::serialize_contract_call_arg(
            nft_id,
            ___contract_call___.get_mut_arg_buffer(),
    ...
    > {
        ...
        let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
            ...
            ___payment___,
            ___nonce___,
            numbat_wasm::types::BoxedBytes::from(&b"accept_anything_transfer_nft"[..]),
        );
        numbat_wasm::io::serialize_contract_call_arg(
            nft_id,
            ___contract_call___.get_mut_arg_buffer(),
    ...
    > {
        ...
        let mut ___contract_call___ = numbat_wasm::types::new_contract_call(
            ...
            annotation_payment_amount,
            annotation_payment_nonce,
            numbat_wasm::types::BoxedBytes::from(&b"accept_rewa_check_annotations_call_value"[..]),
        );
        ___contract_call___
    }
    #[allow(clippy::too_many_arguments)]
...
impl<SA> call_sync::ProxyTrait for Proxy<SA> where SA: numbat_wasm::api::SendApi {}
impl<SA> call_async::ProxyTrait for Proxy<SA> where SA: numbat_wasm::api::SendApi {}
impl<SA> call_transf_exec::ProxyTrait for Proxy<SA> where SA: numbat_wasm::api::SendApi {}
impl<SA> contract_change_owner::ProxyTrait for Proxy<SA> where SA: numbat_wasm::api::SendApi {}
impl<SA> contract_deploy::ProxyTrait for Proxy<SA> where SA: numbat_wasm::api::SendApi {}
impl<SA> contract_update::ProxyTrait for Proxy<SA> where SA: numbat_wasm::api::SendApi {}
impl<SA> dcdt::ProxyTrait for Proxy<SA> where SA: numbat_wasm::api::SendApi {}
impl<SA> sft::ProxyTrait for Proxy<SA> where SA: numbat_wasm::api::SendApi {}
impl<SA> nft::ProxyTrait for Proxy<SA> where SA: numbat_wasm::api::SendApi {}
impl<SA> roles::ProxyTrait for Proxy<SA> where SA: numbat_wasm::api::SendApi {}
impl<SA> storage::ProxyTrait for Proxy<SA> where SA: numbat_wasm::api::SendApi {}
