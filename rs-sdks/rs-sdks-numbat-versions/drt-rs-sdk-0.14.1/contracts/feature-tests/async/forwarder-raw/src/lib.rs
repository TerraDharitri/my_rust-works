...
#[numbat_wasm_derive::contract(ForwarderRawImpl)]
pub trait ForwarderRaw {
	...
	fn forward_direct_dcdt_via_transf_exec(
		...
		self.send()
			.direct_dcdt_via_transf_exec(&to, &token.as_dcdt_identifier(), &payment, &[]);
	}
