...
//   Hasher: std default (SipHash) and crate default (DRTAHash).
...
use drthashbrown::{HashMap, HashSet};
use std::{
...
type DRTAHashMap<K, V> = HashMap<K, V, DefaultHashBuilder>;
...
macro_rules! bench_suite {
    ($bench_macro:ident, $bench_drtahash_serial:ident, $bench_std_serial:ident,
     $bench_drtahash_highbits:ident, $bench_std_highbits:ident,
     $bench_drtahash_random:ident, $bench_std_random:ident) => {
        $bench_macro!($bench_drtahash_serial, DRTAHashMap, 0..);
        $bench_macro!($bench_std_serial, StdHashMap, 0..);
        $bench_macro!(
            $bench_drtahash_highbits,
            DRTAHashMap,
        ...
        $bench_macro!($bench_drtahash_random, DRTAHashMap, RandomKeys::new());
...
bench_suite!(
    bench_insert,
    insert_drtahash_serial,
    insert_std_serial,
    insert_drtahash_highbits,
    insert_std_highbits,
    insert_drtahash_random,
    insert_std_random
);
...
bench_suite!(
    bench_grow_insert,
    grow_insert_drtahash_serial,
    grow_insert_std_serial,
    grow_insert_drtahash_highbits,
    grow_insert_std_highbits,
    grow_insert_drtahash_random,
...
bench_suite!(
    bench_insert_erase,
    insert_erase_drtahash_serial,
    insert_erase_std_serial,
    insert_erase_drtahash_highbits,
    insert_erase_std_highbits,
    insert_erase_drtahash_random,
...
bench_suite!(
    bench_lookup,
    lookup_drtahash_serial,
    lookup_std_serial,
    lookup_drtahash_highbits,
    lookup_std_highbits,
    lookup_drtahash_random,
    lookup_std_random
);
...
bench_suite!(
    bench_lookup_fail,
    lookup_fail_drtahash_serial,
    lookup_fail_std_serial,
    lookup_fail_drtahash_highbits,
    lookup_fail_std_highbits,
    lookup_fail_drtahash_random,
...
bench_suite!(
    bench_iter,
    iter_drtahash_serial,
    iter_std_serial,
    iter_drtahash_highbits,
    iter_std_highbits,
    iter_drtahash_random,
    iter_std_random
);
