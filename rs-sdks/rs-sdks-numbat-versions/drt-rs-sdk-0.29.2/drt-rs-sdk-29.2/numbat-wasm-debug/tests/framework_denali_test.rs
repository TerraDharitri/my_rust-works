...
fn set_check_balance_err_rs() {
    numbat_wasm_debug::denali_rs("tests/denali/set-check/set-check-balance.err.json", world());
}
...
fn set_check_code_err_rs() {
    numbat_wasm_debug::denali_rs("tests/denali/set-check/set-check-code.err.json", world());
}

#[test]
fn set_check_code() {
    numbat_wasm_debug::denali_rs("tests/denali/set-check/set-check-code.scen.json", world());
}

#[test]
#[should_panic]
fn set_check_dcdt_err_rs() {
    numbat_wasm_debug::denali_rs("tests/denali/set-check/set-check-dcdt.err.json", world());
}

#[test]
fn set_check_dcdt_rs() {
    numbat_wasm_debug::denali_rs("tests/denali/set-check/set-check-dcdt.scen.json", world());
}

#[test]
#[should_panic]
fn set_check_nonce_err_rs() {
    numbat_wasm_debug::denali_rs("tests/denali/set-check/set-check-nonce.err.json", world());
}

#[test]
fn set_check_nonce_rs() {
    numbat_wasm_debug::denali_rs("tests/denali/set-check/set-check-nonce.scen.json", world());
}
...
fn builtin_func_dcdt_transfer() {
    numbat_wasm_debug::denali_rs("tests/denali/builtin-func-dcdt-transfer.scen.json", world());
}
...
fn multi_transfer_dcdt_rs() {
    numbat_wasm_debug::denali_rs("tests/denali/multi-transfer-dcdt.scen.json", world());
}

#[test]
fn transfer_rewa_rs() {
    numbat_wasm_debug::denali_rs("tests/denali/transfer-rewa.scen.json", world());
}

#[test]
fn transfer_dcdt_rs() {
    numbat_wasm_debug::denali_rs("tests/denali/transfer-dcdt.scen.json", world());
}

#[test]
fn validator_reward_rs() {
    numbat_wasm_debug::denali_rs("tests/denali/validatorReward.scen.json", world());
}
