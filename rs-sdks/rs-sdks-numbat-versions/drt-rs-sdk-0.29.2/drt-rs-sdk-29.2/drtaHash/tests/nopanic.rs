...
fn hash_test_final(num: i32, string: &str) -> (u64, u64) {
    ...
    let mut hasher1 = DRTAHasher::new_with_keys(1, 2);
    let mut hasher2 = DRTAHasher::new_with_keys(3, 4);
...
fn hash_test_specialize(num: i32, string: &str) -> (u64, u64) {
    let hasher1 = DRTAHasher::new_with_keys(1, 2);
    let hasher2 = DRTAHasher::new_with_keys(1, 2);
    (
