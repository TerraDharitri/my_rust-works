...
impl DRTAHasher {
    ...
    pub fn new_with_keys(key1: u128, key2: u128) -> DRTAHasher {
    ...
    #[inline]
    #[allow(dead_code)] // Is not called if non-fallback hash is used.
    pub(crate) fn from_random_state(rand_state: &RandomState) -> DRTAHasher {
        DRTAHasher {
...
mod tests {
    ...
    #[test]
    fn test_hash() {
        let mut hasher = DRTAHasher::new_with_keys(0, 0);
        let value: u64 = 1 << 32;
        hasher.update(value);
