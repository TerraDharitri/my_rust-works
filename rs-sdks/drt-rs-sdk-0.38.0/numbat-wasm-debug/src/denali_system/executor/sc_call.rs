...
pub fn tx_dcdt_transfers_from_denali(denali_transf_dcdt: &[TxDCDT]) -> Vec<TxTokenTransfer> {
    denali_transf_dcdt
        .iter()
...
pub fn tx_dcdt_transfer_from_denali(denali_transf_dcdt: &TxDCDT) -> TxTokenTransfer {
    TxTokenTransfer {
