...
pub trait Factory {
    ...
    fn create_pair(&self, token_id_pair: TokenIdPair) -> SCResult<Address> {
        ...
        arguments.push_argument_bytes(token_id_pair.first_token_id.as_dcdt_identifier());
        arguments.push_argument_bytes(token_id_pair.second_token_id.as_dcdt_identifier());
