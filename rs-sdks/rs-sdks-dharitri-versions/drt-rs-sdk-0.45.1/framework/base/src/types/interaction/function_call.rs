...
use crate::{
    ...
    api::{
        ManagedTypeApi, DCDT_MULTI_TRANSFER_FUNC_NAME, DCDT_NFT_TRANSFER_FUNC_NAME,
        DCDT_TRANSFER_FUNC_NAME,
    },
    formatter::SCLowerHex,
    types::{
        DcdtTokenPayment, ManagedAddress, ManagedBuffer, ManagedBufferCachedBuilder, ManagedVec,
        MultiValueEncoded,
    },
};
    ...
    Api: ManagedTypeApi,
{
    ...
    pub(super) fn convert_to_multi_transfer_dcdt_call(
        self,
        to: &ManagedAddress<Api>,
