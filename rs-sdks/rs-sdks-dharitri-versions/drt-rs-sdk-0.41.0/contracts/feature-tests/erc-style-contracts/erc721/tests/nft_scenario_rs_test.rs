...
fn nft_approve_non_owned_token_rs() {
    dharitri_sc_scenario::run_rs("scenarios/nft-approve-non-owned-token.scen.json", world());
}

#[test]
fn nft_approve_ok_rs() {
    dharitri_sc_scenario::run_rs("scenarios/nft-approve-ok.scen.json", world());
}

#[test]
fn nft_init_rs() {
    dharitri_sc_scenario::run_rs("scenarios/nft-init.scen.json", world());
}
...
fn nft_revoke_non_approved_rs() {
    dharitri_sc_scenario::run_rs("scenarios/nft-revoke-non-approved.scen.json", world());
}

#[test]
fn nft_revoke_ok_rs() {
    dharitri_sc_scenario::run_rs("scenarios/nft-revoke-ok.scen.json", world());
}

#[test]
fn nft_transfer_approved_token_rs() {
    dharitri_sc_scenario::run_rs("scenarios/nft-transfer-approved-token.scen.json", world());
}
...
fn nft_transfer_ok_rs() {
    dharitri_sc_scenario::run_rs("scenarios/nft-transfer-ok.scen.json", world());
}
...
fn nft_transfer_token_ok_rs() {
    dharitri_sc_scenario::run_rs("scenarios/nft-transfer-token-ok.scen.json", world());
}
