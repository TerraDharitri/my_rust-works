...
impl BigIntApi for DebugApi {
    ...
    fn bi_sign(&self, x: Self::BigIntHandle) -> dharitri_sc::api::Sign {
        let bi = self.bi_get(x);
        match bi.sign() {
            num_bigint::Sign::Minus => dharitri_sc::api::Sign::Minus,
            num_bigint::Sign::NoSign => dharitri_sc::api::Sign::NoSign,
            num_bigint::Sign::Plus => dharitri_sc::api::Sign::Plus,
        }
    }
