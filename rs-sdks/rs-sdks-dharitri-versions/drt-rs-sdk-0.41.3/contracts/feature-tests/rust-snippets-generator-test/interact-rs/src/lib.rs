...
impl State {
    ...
    async fn dcdt_token_payment(&mut self) {
        ...
        let result: dharitri_sc_snippets::InteractorResult<DcdtTokenPayment<DebugApi>> = self
            .interactor
            .sc_call_get_result(
                self.contract
    ...
    async fn rewa_or_dcdt_payment(&mut self) {
        ...
        let result: dharitri_sc_snippets::InteractorResult<RewaOrDcdtTokenIdentifier<DebugApi>> = self
            .interactor
            .sc_call_get_result(
                self.contract
