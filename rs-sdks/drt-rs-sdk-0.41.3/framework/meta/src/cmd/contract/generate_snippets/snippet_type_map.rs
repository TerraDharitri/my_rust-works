...
fn init_rust_types_map() -> HashMap<&'static str, RustTypeString> {
    ...
    m.insert(
        ...
        RustTypeString {
            type_name: "RewaOrDcdtTokenIdentifier".to_string() + DEBUG_API_SUFFIX,
    ...
    m.insert(
        "DcdtTokenPayment",
        RustTypeString {
            type_name: "DcdtTokenPayment".to_string() + DEBUG_API_SUFFIX,
    ...
    m.insert(
        ...
        RustTypeString {
            type_name: "RewaOrDcdtTokenPayment".to_string() + DEBUG_API_SUFFIX,
