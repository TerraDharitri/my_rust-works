...
use super::{
    ...
    CheckStateStep, NewAddress, ScCallStep, ScDeployStep, ScQueryStep, SetStateStep, TxDCDT,
    TxExpect, U64Value,
};
...
impl ScDeployStep {
    ...
    {
        self.tx.rewa_value = BigUintValue::interpret_from(expr, &InterpreterContext::default());
        self
    }
...
impl ScCallStep {
        ...
        BigUintValue: InterpretableFrom<A>,
    {
        ...
        self.tx.rewa_value = BigUintValue::interpret_from(amount, &InterpreterContext::default());
        self
    }
        ...
        BigUintValue: InterpretableFrom<A>,
    {
        ...
        self.tx.dcdt_value.push(TxDCDT {
            dcdt_token_identifier: BytesValue::interpret_from(token_id, &ctx),
            nonce: U64Value::interpret_from(token_nonce, &ctx),
            dcdt_value: BigUintValue::interpret_from(amount, &ctx),
        });
