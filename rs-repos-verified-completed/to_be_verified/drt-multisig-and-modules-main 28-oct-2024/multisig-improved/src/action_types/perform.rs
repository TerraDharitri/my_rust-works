...
use crate::common_types::action::{
    ActionFullInfo, ActionId, ActionStatus, CallActionData, DcdtTransferExecuteData,
};
    ...
    + crate::ms_endpoints::callbacks::CallbacksModule
{
    ...
    fn try_perform_rewa_action_directly(
        &self,
        ...
        let can_execute = self.can_execute_action(CanExecuteArgs {
            ...
            rewa_value: &call_data.rewa_amount,
            dcdt_payments: &PaymentsVec::new(),
        });
        if !can_execute {
            return false;
        }
    ...
    fn try_perform_dcdt_action_directly(
        &self,
        proposer: &ManagedAddress,
        action_id: ActionId,
        ...
        let can_execute = self.can_execute_action(CanExecuteArgs {
            ...
            dcdt_payments: &call_data.tokens,
        });
        if !can_execute {
            return false;
        }
