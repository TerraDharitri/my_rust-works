...
//     lending_setup
//         .b_mock
//         .set_nft_balance(&user_addr, LEND_REWA, 1, &rust_biguint!(10 * BP), &Empty);
...
//     lending_setup
//         .b_mock
//         .set_nft_balance(&user_addr, LEND_REWA, 2, &rust_biguint!(10 * BP), &Empty);

//     let mut payments = Vec::with_capacity(2);

//     payments.push(TxInputDCDT {
...
//     payments.push(TxInputDCDT {
//         token_identifier: LEND_REWA.to_vec(),
//         nonce: 2,
...
//     lending_setup
//         .b_mock
//         .set_dcdt_balance(&borrower_addr, REWA_TOKEN_ID, &rust_biguint!(1_000));
...
//         .execute_dcdt_transfer(
//             &borrower_addr,
//             &lending_setup.liquidity_pool_rewa_wrapper,
//             REWA_TOKEN_ID,
//             0,
//             &rust_biguint!(1_000),
//             |sc| {
...
//                     managed_biguint!(REWA_PRICE_DROPPED_IN_DOLLARS),
//                 );
//             },
//         )
//         .assert_ok();
...
//     // Check Liquidator Balance - LEND_REWA tokens
//     lending_setup.b_mock.check_nft_balance(
//         &liquidator_addr,
//         LEND_REWA,
//         1,
...
//     lending_setup
//         .b_mock
//         .set_nft_balance(&dave_addr, LEND_REWA, 4, &rust_biguint!(60 * BP), &Empty);
...
//     lending_setup
//         .b_mock
//         .set_nft_balance(&eve_addr, LEND_REWA, 5, &rust_biguint!(120 * BP), &Empty);
