import { createAirdropService, createDCDTInteractor, ITestSession, ITestUser } from "@numbatnetwork/drtjs-snippets";
import { TokenPayment } from "@numbatnetwork/drtjs/out";
