...
use dharitri_sc_snippets::imports::TestTokenIdentifier;
use dharitri_sc_snippets::{
    imports::{BigUint, DcdtTokenPayment, MultiValueEncoded, StaticApi},
    tokio,
};
...
async fn paint_scenario() {
    ...
    let payment = DcdtTokenPayment::<StaticApi>::from((
