...
use dharitri_sc_snippets::sdk::gateway::GatewayAsyncService;
use dharitri_sc_snippets::{imports::*, sdk::gateway::GetAccountStorageRequest};
...
const CODE_PATH: DrtscPath = DrtscPath::new("../paint-the-moon-sc/output/paint-the-moon.drtsc.json");
