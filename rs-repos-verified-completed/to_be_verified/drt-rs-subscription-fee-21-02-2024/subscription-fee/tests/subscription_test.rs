...
fn subscribe_before_approve_test() {
    ...
    b_mock_rc
        .borrow_mut()
        .set_dcdt_balance(&user, FIRST_TOKEN_ID, &rust_biguint!(1_000_000));
...
fn subtract_ok_test() {
    ...
    b_mock_rc
        .borrow()
        .check_dcdt_balance(&rand_service, FIRST_TOKEN_ID, &rust_biguint!(1_000));
}
...
fn any_token_subtract_fee_test() {
    ...
    b_mock_rc
        .borrow()
        .check_dcdt_balance(&rand_service, FIRST_TOKEN_ID, &rust_biguint!(500));
}
...
fn withdraw_tokens_test() {
    ...
    b_mock_rc
        .borrow()
        .check_dcdt_balance(&user, FIRST_TOKEN_ID, &rust_biguint!(999_999));
    ...
    b_mock_rc
        .borrow()
        .check_dcdt_balance(&rand_service, FIRST_TOKEN_ID, &rust_biguint!(0));
}
