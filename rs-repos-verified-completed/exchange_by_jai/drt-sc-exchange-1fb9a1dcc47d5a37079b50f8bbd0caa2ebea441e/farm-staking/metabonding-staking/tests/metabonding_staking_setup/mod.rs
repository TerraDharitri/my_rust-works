...
use dharitri_sc::types::{Address, DcdtLocalRole, ManagedVec};
...
pub const ASSET_TOKEN_ID: &[u8] = b"MOA-123456";
pub const LOCKED_ASSET_TOKEN_ID: &[u8] = b"LKMOA-123456";
    ...
    LockedAssetFactoryObjBuilder: 'static + Copy + Fn() -> factory::ContractObj<DebugApi>,
{
    ...
    pub fn call_stake_locked_asset_multiple(&mut self, payments: &[TxTokenTransfer]) -> TxResult {
        self.b_mock.execute_dcdt_multi_transfer(
            &self.user_address,
            &self.mbs_wrapper,
            payments,
            |sc| {
