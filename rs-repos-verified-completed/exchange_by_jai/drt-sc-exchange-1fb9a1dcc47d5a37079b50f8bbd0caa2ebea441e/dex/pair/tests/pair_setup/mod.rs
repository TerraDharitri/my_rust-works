...
use dharitri_sc::types::{
    Address, DcdtLocalRole, DcdtTokenPayment, ManagedAddress, MultiValueEncoded,
};
...
pub const USER_TOTAL_MOA_TOKENS: u64 = 5_000_000_000;
    ...
    pub fn add_liquidity(
        ...
        self.b_mock
            .execute_dcdt_multi_transfer(&self.user_address, &self.pair_wrapper, &payments, |sc| {
                ...
                assert_eq!(payments.2.token_identifier, managed_token_id!(MOA_TOKEN_ID));
