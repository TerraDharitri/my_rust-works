...
fn try_lock() {
    ...
    setup
        .b_mock
        .set_dcdt_balance(&first_user, b"FAKETOKEN-123456", &rust_biguint!(1_000));
...
fn lock_ok() {
    ...
    setup
        .b_mock
        .check_dcdt_balance(&first_user, BASE_ASSET_TOKEN_ID, &rust_biguint!(0));
...
fn unlock_early_test() {
    ...
    setup
        .b_mock
        .check_dcdt_balance(&first_user, BASE_ASSET_TOKEN_ID, &expected_balance);
