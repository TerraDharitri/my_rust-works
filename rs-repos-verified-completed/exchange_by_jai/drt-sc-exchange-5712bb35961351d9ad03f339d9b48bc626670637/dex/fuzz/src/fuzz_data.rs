...
pub mod fuzz_data_tests {
    ...
    pub const MOA_TOKEN_ID: &[u8] = b"MOA-abcdef";
    ...
    pub const MOA_FARM_TOKEN_ID: &[u8] = b"MOAFARM-abcdef";
    pub const LOCKED_MOA_TOKEN_ID: &[u8] = b"LKMOA-abcdef";
    ...
    pub const USER_TOTAL_MOA_TOKENS: u64 = 100_000_000_000;
        ...
        pub fn new(
            ...
            for i in 1..=fuzz_args.num_users {
                ...
                blockchain_wrapper.set_dcdt_balance(
                    &user_address,
                    MOA_TOKEN_ID,
                    &rust_biguint!(USER_TOTAL_MOA_TOKENS),
                );
                blockchain_wrapper.set_dcdt_balance(
                    &user_address,
                    BUSD_TOKEN_ID,
        ...
        FactoryObjBuilder: 'static + Copy + Fn() -> factory::ContractObj<DebugApi>,
    {
        ...
        blockchain_wrapper
            .execute_tx(owner_addr, &factory_wrapper, &rust_biguint!(0), |sc| {
                let asset_token_id = managed_token_id!(MOA_TOKEN_ID);
                let locked_asset_token_id = managed_token_id!(LOCKED_MOA_TOKEN_ID);
        ...
        let token_roles = [DcdtLocalRole::Mint, DcdtLocalRole::Burn];
