...
pub const MIN_FEE_FOR_PROPOSE: u64 = 1_000_000_000; // 1B MOA
...
pub const MOA_TOKEN_ID: &[u8] = b"MOA-123456";
pub const XMOA_TOKEN_ID: &[u8] = b"XMOA-123456";
    ...
    pub fn new(gov_builder: GovBuilder) -> Self {
        ...
        b_mock
            .execute_tx(&owner, &fees_collector_wrapper, &rust_biguint!(0), |sc| {
                sc.init(
                    managed_token_id!(XMOA_TOKEN_ID),
        ...
        b_mock
            .execute_tx(&owner, &gov_wrapper, &rust_zero, |sc| {
                sc.fee_token_id().set(managed_token_id!(MOA_TOKEN_ID));
            })
            .assert_ok();
