...
use dharitri_sc::types::{DcdtTokenPayment, ManagedVec, TokenIdentifier};
    ...
    blockchain_wrapper
        .execute_query(&factory, |sc| {
            ...
            let token1 = LockedTokenEx::<DebugApi> {
                token_amount: DcdtTokenPayment {
                    token_identifier: TokenIdentifier::from_dcdt_bytes(&[]), //placeholder
