    ...
    + legacy_token_decode_module::LegacyTokenDecodeModule
{
    ...
    fn migrate_old_tokens(&self) -> MultiValueEncoded<DcdtTokenPayment> {
        self.require_not_paused();
    ...
    fn migrate_single_old_token(
        ...
        let base_asset = RewaOrDcdtTokenIdentifier::dcdt(self.base_asset_token_id().get());
        let original_unlocked_tokens = RewaOrDcdtTokenPayment::new(base_asset, 0, payment.amount);
