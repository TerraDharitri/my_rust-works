    ...
    Gas: TxGas<Env>,
{
    ...
    ) -> TxProxyCall<Env, From, To, Gas, MultiValue3<DcdtTokenPayment<Env::Api>, DcdtTokenPayment<Env::Api>, DcdtTokenPayment<Env::Api>>> {
        self.wrapped_tx
    ...
    >(
        ...
        first_token_amount_min: Arg0,
        second_token_amount_min: Arg1,
    ) -> TxProxyCall<Env, From, To, Gas, MultiValue2<DcdtTokenPayment<Env::Api>, DcdtTokenPayment<Env::Api>>> {
        self.wrapped_tx
