...
pub mod fuzz_pair_test {
        ...
        PriceDiscObjBuilder: 'static + Copy + Fn() -> price_discovery::ContractObj<DebugApi>,
    {
        ...
        let first_token_before =
            fuzzer_data
                .blockchain_wrapper
                .get_dcdt_balance(&caller.address, first_token, 0);
        let second_token_before =
            fuzzer_data
                .blockchain_wrapper
                .get_dcdt_balance(&caller.address, second_token, 0);
        let lp_token_before =
            fuzzer_data
                .blockchain_wrapper
                .get_dcdt_balance(&caller.address, lp_token, 0);
        ...
        let tx_result = fuzzer_data.blockchain_wrapper.execute_dcdt_multi_transfer(
            &caller.address,
        ...
        PriceDiscObjBuilder: 'static + Copy + Fn() -> price_discovery::ContractObj<DebugApi>,
    {
        ...
        let desired_token_before =
            fuzzer_data
                .blockchain_wrapper
                .get_dcdt_balance(&caller.address, desired_token_id, 0);
        ...
        if swap_fixed_input {
            ...
            let payment_token_after = fuzzer_data.blockchain_wrapper.get_dcdt_balance(
                &caller.address,
                payment_token_id,
                0,
            );

            let desired_token_after = fuzzer_data.blockchain_wrapper.get_dcdt_balance(
                &caller.address,
                desired_token_id,
                0,
            );
