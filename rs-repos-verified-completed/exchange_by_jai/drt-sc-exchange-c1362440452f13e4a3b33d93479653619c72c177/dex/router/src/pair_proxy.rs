    ...
    Gas: TxGas<Env>,
{
    ...
    >(
        ...
        pair_address: Arg0,
        liquidity: Arg1,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, MultiValue2<DcdtTokenPayment<Env::Api>, DcdtTokenPayment<Env::Api>>> {
        self.wrapped_tx
            .payment(NotPayable)
    ...
    pub fn get_safe_price_by_default_offset<
        Arg0: ProxyArg<ManagedAddress<Env::Api>>,
        Arg1: ProxyArg<DcdtTokenPayment<Env::Api>>,
    >(
        self,
        pair_address: Arg0,
        input_payment: Arg1,
    ...
    pub fn get_safe_price_by_round_offset<
        Arg0: ProxyArg<ManagedAddress<Env::Api>>,
        Arg1: ProxyArg<u64>,
        Arg2: ProxyArg<DcdtTokenPayment<Env::Api>>,
    >(
        self,
        pair_address: Arg0,
        round_offset: Arg1,
    ...
    pub fn get_safe_price<
        ...
        Arg1: ProxyArg<u64>,
        Arg2: ProxyArg<u64>,
        Arg3: ProxyArg<DcdtTokenPayment<Env::Api>>,
    >(
        self,
        pair_address: Arg0,
        start_round: Arg1,
    ...
    pub fn update_and_get_safe_price<
        Arg0: ProxyArg<DcdtTokenPayment<Env::Api>>,
    >(
        self,
        input: Arg0,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, DcdtTokenPayment<Env::Api>> {
    ...
    >(
        ...
        first_token_amount_min: Arg0,
        second_token_amount_min: Arg1,
    ) -> TxTypedCall<Env, From, To, (), Gas, MultiValue2<DcdtTokenPayment<Env::Api>, DcdtTokenPayment<Env::Api>>> {
        self.wrapped_tx
