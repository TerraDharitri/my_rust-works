...
use dharitri_sc::types::{DcdtLocalRole, MultiValueEncoded};
...
fn lock_whitelist_test() {
    ...
    b_mock.set_dcdt_balance(&user_addr, FREE_TOKEN_ID, &lock_amount);
    b_mock.set_dcdt_balance(&user_addr, OTHER_TOKEN_ID, &lock_amount);
