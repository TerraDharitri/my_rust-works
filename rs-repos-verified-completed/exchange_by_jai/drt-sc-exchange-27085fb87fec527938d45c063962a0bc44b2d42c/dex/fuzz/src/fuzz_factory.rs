...
pub mod fuzz_factory_test {
        ...
        PriceDiscObjBuilder: 'static + Copy + Fn() -> price_discovery::ContractObj<DebugApi>,
    {
        ...
        let token_before =
            fuzzer_data
                .blockchain_wrapper
                .get_dcdt_balance(&caller.address, token_id, 0);
        ...
        PriceDiscObjBuilder: 'static + Copy + Fn() -> price_discovery::ContractObj<DebugApi>,
    {
        ...
        let locked_token_before = fuzzer_data.blockchain_wrapper.get_dcdt_balance(
            &caller.address,
            locked_token_id,
            locked_token_nonce,
        );
        ...
        let locked_token_after = fuzzer_data.blockchain_wrapper.get_dcdt_balance(
            &caller.address,
            locked_token_id,
            locked_token_nonce,
        );
