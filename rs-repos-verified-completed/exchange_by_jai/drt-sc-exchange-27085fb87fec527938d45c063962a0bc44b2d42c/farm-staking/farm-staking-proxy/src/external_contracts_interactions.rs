...
pub type SafePriceResult<Api> = MultiValue2<DcdtTokenPayment<Api>, DcdtTokenPayment<Api>>;
    ...
    crate::lp_farm_token::LpFarmTokenModule + utils::UtilsModule + energy_query::EnergyQueryModule
{
    ...
    fn merge_lp_farm_tokens(
        &self,
        orig_caller: ManagedAddress,
        base_lp_farm_token: DcdtTokenPayment,
        ...
        if additional_lp_farm_tokens.is_empty() {
            ...
            let rewards_payment = DcdtTokenPayment::new(locked_token_id, 0, BigUint::zero());
