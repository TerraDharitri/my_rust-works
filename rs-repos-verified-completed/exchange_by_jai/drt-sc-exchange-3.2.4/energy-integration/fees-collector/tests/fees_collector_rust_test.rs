...
use dharitri_sc::types::{BigInt, DcdtTokenPayment, ManagedVec};
...
fn claim_first_week_test() {
    ...
    fc_setup
        .b_mock
        .check_dcdt_balance(&first_user, FIRST_TOKEN_ID, &rust_zero);
    fc_setup
        .b_mock
        .check_dcdt_balance(&second_user, FIRST_TOKEN_ID, &rust_zero);
...
fn claim_after_dex_inactive_test() {
    ...
    fc_setup.b_mock.check_dcdt_balance(
        &first_user,
        FIRST_TOKEN_ID,
...
fn claim_second_week_test() {
    ...
    fc_setup
        ...
        .execute_query(&fc_setup.fc_wrapper, |sc| {
            ...
            expected_total_rewards.push(DcdtTokenPayment::new(
