    ...
    + energy_query::EnergyQueryModule
{
    ...
    fn remove_liquidity_proxy(
        ...
        payments_vec.push(DcdtTokenPayment::new(
        ...
        if assets_received > locked_assets_invested {
            ...
            self.send()
                .direct_dcdt(&caller, &asset_token_id, 0, &difference);
        ...
        self.send()
            .dcdt_local_burn(&asset_token_id, 0, &locked_assets_to_send);
        self.send()
            .dcdt_local_burn(&wrapped_lp_token_id, token_nonce, &amount);
    ...
    fn actual_remove_liquidity(
        ...
        let raw_results: RawResultsType<Self::Api> = self
            ...
            .with_dcdt_transfer((lp_token_id.clone(), 0, liquidity.clone()))
