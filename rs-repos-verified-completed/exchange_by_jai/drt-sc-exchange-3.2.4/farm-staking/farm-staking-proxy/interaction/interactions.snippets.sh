...
# Deploy RIDE Proxy Staking Farm from MOA rewards
# $ deployProxyStakeFarmContract $LP_FARM_MOA_ADDRESS $STAKING_FARM_ADDRESS $LP_PAIR_ADDRESS $STAKING_TOKEN_ID $LP_FARM_MOA_TOKEN_ID $STAKING_FARM_TOKEN_ID $LP_TOKEN_ID
...
# $ registerDualYieldToken $PROXY_STAKING_FARM_MOA MetaStakedRide METARIDE 18
# $ registerDualYieldToken $PROXY_STAKING_FARM_LKMOA MetaStakedRideLK METARIDELK 18

# Set local roles for DualYield Tokens
# $ setLocalRolesDualYieldToken $PROXY_STAKING_FARM_MOA
