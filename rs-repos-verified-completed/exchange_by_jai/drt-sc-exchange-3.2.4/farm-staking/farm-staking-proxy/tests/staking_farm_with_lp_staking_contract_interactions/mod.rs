    ...
    ProxyContractObjBuilder: 'static + Copy + Fn() -> farm_staking_proxy::ContractObj<DebugApi>,
{
    ...
    pub fn stake_farm_lp_proxy_multiple(
        ...
        self.b_mock
            .execute_dcdt_multi_transfer(&self.user_addr, &self.proxy_wrapper, &transfers, |sc| {
    ...
    pub fn stake_farm_on_behalf(
        ...
        b_mock
            .execute_dcdt_multi_transfer(caller, &self.proxy_wrapper, &payments, |sc| {
