    ...
    T: Clone + TopEncode + TopDecode + NestedEncode + NestedDecode,
{
    ...
    pub rewards: DcdtTokenPayment<C::Api>,
    ...
    + utils::UtilsModule
{
    fn claim_rewards_base<FC: FarmContract<FarmSc = Self>>(
        ...
        let minted_farm_token_nonce = self.send().dcdt_nft_create_compact(
    ...
    fn claim_rewards_base_no_farm_token_mint<FC: FarmContract<FarmSc = Self>>(
        ...
        InternalClaimRewardsResult {
            ...
            rewards: DcdtTokenPayment::new(storage_cache.reward_token_id.clone(), 0, reward),
            new_farm_token,
            storage_cache,
        }
    }
