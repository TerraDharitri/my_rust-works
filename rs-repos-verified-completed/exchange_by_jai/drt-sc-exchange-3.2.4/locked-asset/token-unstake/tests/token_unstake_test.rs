...
fn unstake_and_unbond_test() {
    ...
    setup
        .b_mock
        .check_dcdt_balance(&first_user, BASE_ASSET_TOKEN_ID, &user_balance_after_unbond);
...
fn unstake_multiple_position_test() {
    ...
    setup
        .b_mock
        .check_dcdt_balance(&first_user, BASE_ASSET_TOKEN_ID, &balance_after_all_unlocks);
}
    ...
    setup
        ...
        .execute_query(&setup.unstake_sc_wrapper, |sc| {
            ...
            let expected_entries = ManagedVec::from_single_item(UnstakePair {
                ...
                unlocked_tokens: DcdtTokenPayment::new(
