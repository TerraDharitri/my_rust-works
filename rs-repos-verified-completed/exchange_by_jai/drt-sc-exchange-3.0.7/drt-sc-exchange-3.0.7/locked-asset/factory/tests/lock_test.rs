...
use dharitri_sc::{
    ...
    types::{DcdtLocalRole, ManagedVec, MultiValueEncoded},
};
...
const ASSET_TOKEN_ID: &[u8] = b"MOA-123456";
const LOCKED_ASSET_TOKEN_ID: &[u8] = b"LKMOA-123456";
...
fn test_lock_assets() {
    ...
    let asset_token_roles = [DcdtLocalRole::Burn];
    ...
    blockchain_wrapper.set_dcdt_balance(&owner_addr, ASSET_TOKEN_ID, &rust_biguint!(2000));
