...
pub trait UtilsModule {
    ...
    fn to_dcdt_payment(
        &self,
        rewa_or_dcdt_payment: RewaOrDcdtTokenPayment<Self::Api>,
    ) -> DcdtTokenPayment {
        DcdtTokenPayment::new(
            rewa_or_dcdt_payment.token_identifier.unwrap_dcdt(),
            rewa_or_dcdt_payment.token_nonce,
            rewa_or_dcdt_payment.amount,
        )
    }
