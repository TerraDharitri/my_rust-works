...
use super::{
    common_types::{Nonce, PaymentsVec, UniquePayments, REWA_TOKEN_ID},
    signature::Signature,
};
...
pub trait UsersModule: super::signature::SignatureModule {
    ...
    fn deposit_for_user(&self, user_address: ManagedAddress) {
        ...
        let payments = self.get_dcdt_and_rewa_payments();
    ...
    fn get_dcdt_and_rewa_payments(&self) -> PaymentsVec<Self::Api> {
    ...
    fn deduct_single_payment(&self, user_id: AddressId, tokens: &DcdtTokenPayment) {
