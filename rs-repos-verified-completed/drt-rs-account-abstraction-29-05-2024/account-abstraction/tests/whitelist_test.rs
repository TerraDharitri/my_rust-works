...
use account_abstraction::{
    common::common_types::REWA_TOKEN_ID, user_actions::whitelist_actions::WhitelistActionsModule,
};
use dharitri_sc::{
    imports::OptionalValue,
    types::{DcdtTokenPayment, ManagedAddress, ManagedBuffer, ManagedVec, MultiValueEncoded},
};
...
fn whitelist_actions_test() {
        ...
        .execute_tx(
            ...
            |sc| {
                ...
                sc.take_action(
                    ...
                    args,
                    OptionalValue::Some(DcdtTokenPayment::new(
    ...
    let expected_first_user_tokens = [
        ...
        TxTokenTransfer {
            token_identifier: TOKEN_ID.to_vec(),
            nonce: 0,
            value: rust_biguint!(FIRST_USER_DCDT_BALANCE - 200),
        },
    ];
    setup.check_user_tokens(&first_user_address, &expected_first_user_tokens);
