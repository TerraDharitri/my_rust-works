...
pub const REWA_TICKER: &[u8] = b"WREWA";
pub const REWA_TOKEN_ID: &[u8] = b"WREWA-123456";
pub const REWA_PRICE_IN_DOLLARS: u64 = 20_000; // $200
pub const REWA_PRICE_DROPPED_IN_DOLLARS: u64 = 14_000; // $140
