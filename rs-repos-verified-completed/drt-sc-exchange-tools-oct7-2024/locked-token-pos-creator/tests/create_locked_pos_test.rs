...
use dharitri_sc::types::{
    BigUint, DcdtLocalRole, DcdtTokenPayment, ManagedBuffer, MultiValueEncoded,
};
...
fn create_pair_and_farm_pos_test() {
    ...
    // check proxy balance
    proxy_dex_setup.b_mock.borrow().check_dcdt_balance(
    ...
    b_mock
        ...
        .execute_dcdt_multi_transfer(
            ...
            |sc| {
                ...
                // wrewa_leftover and locked_token_leftover are 0 so output_payments has only 1 element
    ...
    b_mock
        ...
        .execute_dcdt_multi_transfer(
            ...
            |sc| {
                ...
                // wrewa_leftover, locked_token_leftover and boosted rewards are 0
...
fn create_energy_position_test() {
    ...
    b_mock
        ...
        .execute_dcdt_transfer(
            ...
            &rust_biguint!(expected_locked_token_amount),
            |sc| {
                let locked_moa_payment = sc.create_energy_position(
                    LOCK_OPTIONS[2],
                    managed_biguint!(expected_locked_token_amount),
                    MultiValueEncoded::new(),
                );
                assert_eq!(
                    locked_moa_payment.token_identifier,
                    managed_token_id!(LOCKED_TOKEN_ID)
                );
                assert_eq!(locked_moa_payment.token_nonce, 3);
                assert_eq!(locked_moa_payment.amount, expected_locked_token_amount);
            },
        )
        .assert_ok();
    ...
    b_mock
        ...
        .execute_dcdt_transfer(
            ...
            |sc| {
                ...
                assert_eq!(locked_moa_payment.token_nonce, 3);
                assert_eq!(locked_moa_payment.amount, expected_locked_token_amount2);
            },
        )
        .assert_ok();
