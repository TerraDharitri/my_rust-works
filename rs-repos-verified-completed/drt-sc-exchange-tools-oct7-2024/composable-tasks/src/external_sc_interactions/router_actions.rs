...
pub trait RouterActionsModule {
    fn multi_pair_swap(
        &self,
        start_payment: DcdtTokenPayment<Self::Api>,
        ...
        let mut last_payment = RewaOrDcdtTokenPayment::from(start_payment.clone());
        ...
        loop {
            ...
            last_payment.token_identifier = RewaOrDcdtTokenIdentifier::dcdt(token_wanted);
        ...
        let ((), back_transfers) = self
            ...
            .with_dcdt_transfer(start_payment)
