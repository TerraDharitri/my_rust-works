    ...
    + dharitri_sc_modules::default_issue_callbacks::DefaultIssueCallbacksModule
{
    ...
    fn update_farm_after_claim(
        ...
        let new_rewards = if initial_farm_state.reward_reserve > 0 {
            ...
            let current_rewards = DcdtTokenPayment::new(
    ...
    fn apply_fee(&self, payment: &mut DcdtTokenPayment) {
        ...
        if exit_fees_mapper.is_empty() {
            let new_fee = DcdtTokenPayment::new(
    ...
    fn compute_user_rewards_payment(
        ...
        DcdtTokenPayment::new(locked_token_id, farm_state.reward_token_nonce, reward)
    }
