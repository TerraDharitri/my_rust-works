    ...
    + dharitri_sc_modules::default_issue_callbacks::DefaultIssueCallbacksModule
{
    #[payable("*")]
    #[endpoint(enterFarm)]
    fn enter_farm_endpoint(&self, farm_address: ManagedAddress) -> DcdtTokenPayment {
        require!(
        ...
        let current_farm_position = DcdtTokenPayment::new(
            farm_token_id,
    ...
    fn unbond_farm(&self) -> PaymentsVec<Self::Api> {
        ...
        let farm_token_id = self.get_farm_token(farm_address.clone());
        let unstake_payment = DcdtTokenPayment::new(
            farm_token_id.clone(),
        ...
        let empty_payment = DcdtTokenPayment::new(farm_token_id, 0u64, BigUint::zero());
    ...
    fn claim_and_compute_user_rewards(
        ...
        // The contract uses MetaDCDTs for user positions, and only these need to be burned
