...
pub static OTHER_FARM_STAKING_TOKEN_ID: &[u8] = b"WREWA-123456";
...
pub static DCDT_ROLES: &[DcdtLocalRole] = &[DcdtLocalRole::Mint, DcdtLocalRole::Burn];
...
pub static SFT_WITH_TRANSFER_ROLES: &[DcdtLocalRole] = &[
    DcdtLocalRole::NftCreate,
    DcdtLocalRole::NftAddQuantity,
    DcdtLocalRole::NftBurn,
    ...
    FarmStakingProxyObjBuilder: 'static + Copy + Fn() -> farm_staking_proxy::ContractObj<DebugApi>,
{
    pub fn new(
        ...
        b_mock.set_dcdt_local_roles(energy_dao_wrapper.address_ref(), LOCKED_TOKEN_ID, SFT_ROLES);

        let wrapped_locked_reward_token_roles = [DcdtLocalRole::Transfer];
        b_mock.set_dcdt_local_roles(
            energy_dao_wrapper.address_ref(),
    ...
    PairObjBuilder: 'static + Copy + Fn() -> pair::ContractObj<DebugApi>,
{
    ...
    b_mock.set_dcdt_local_roles(pair_wrapper.address_ref(), FARMING_TOKEN_ID, DCDT_ROLES);
