...
pub struct ClaimResult<M: ManagedTypeApi> {
    pub new_wrapped_farm_token: DcdtTokenPayment<M>,
    ...
    + crate::external_sc_interactions::farm_interactions::FarmInteractionsModule
{
    ...
    fn claim_rewards(&self) -> ClaimResult<Self::Api> {
        ...
        let new_wrapped_farm_token = self
            ...
            .payment;
        self.send()
            .direct_non_zero_dcdt_payment(&caller, &new_wrapped_farm_token);
    ...
    fn generate_single_token_reward(
        ...
        if wrapped_token_attributes.creation_block < token_addition_block {
            return DcdtTokenPayment::new(reward_token_id, 0, BigUint::zero());
        }
        ...
        DcdtTokenPayment::new(reward_token_id, 0, rew_amount)
    }
    ...
    fn create_new_wrapped_farm_token_after_claim(
        ...
        new_farm_token: DcdtTokenPayment,
        ...
        self.send()
            .dcdt_local_burn_multi(&claim_rewards_context.additional_payments);
    ...
    fn get_all_underlying_farm_tokens(
        ...
        let first_payment = DcdtTokenPayment::new(
