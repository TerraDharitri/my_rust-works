...
fn enter_lp_through_pos_creator_test() {
    ...
    b_mock
        .borrow()
        .check_dcdt_balance(&user_addr, TOKEN_IDS[0], &rust_biguint!(0));
    b_mock
        .borrow()
        .check_dcdt_balance(&user_addr, TOKEN_IDS[1], &rust_biguint!(0));
    // Should have tokens remaining after add liquidity
    b_mock.borrow().check_dcdt_balance(
        &user_addr,
        TOKEN_IDS[2],
    ...
    b_mock
        .borrow()
        .check_dcdt_balance(&user_addr, LP_TOKEN_IDS[0], &rust_biguint!(0));
    b_mock
        .borrow()
        .check_dcdt_balance(&user_addr, LP_TOKEN_IDS[1], &rust_biguint!(0));
    b_mock.borrow().check_dcdt_balance(
        &user_addr,
        LP_TOKEN_IDS[2],
    ...
    b_mock
        .borrow()
        .check_dcdt_balance(&user_addr, LP_TOKEN_IDS[2], &rust_biguint!(0));
}
...
fn enter_lp_and_farm_through_pos_creator() {
    ...
    b_mock
        .borrow()
        .check_dcdt_balance(&user_addr, TOKEN_IDS[2], &rust_biguint!(0));
    b_mock
        .borrow()
        .check_dcdt_balance(&user_addr, LP_TOKEN_IDS[0], &rust_biguint!(0));
...
fn create_pos_with_farm_boosted_rewards_test() {
    ...
    b_mock
        .borrow_mut()
        .set_dcdt_balance(&user2_addr, TOKEN_IDS[0], &rust_biguint!(1));
    ...
    b_mock
        .borrow()
        .check_dcdt_balance(&user_addr, LP_TOKEN_IDS[0], &rust_biguint!(lp_balance));
