...
fn try_create_lp_pos_from_farm_pos() {
    ...
    b_mock
        ...
        .assert_user_error("Only fungible DCDT accepted");
}
...
fn try_create_position_wrong_tokens_test() {
    ...
    b_mock
        .borrow_mut()
        .set_dcdt_balance(&user_addr, TOKEN_IDS[0], &rust_biguint!(1u64));
    b_mock
        .borrow_mut()
        .set_dcdt_balance(&user_addr, TOKEN_IDS[2], &rust_biguint!(1u64));
