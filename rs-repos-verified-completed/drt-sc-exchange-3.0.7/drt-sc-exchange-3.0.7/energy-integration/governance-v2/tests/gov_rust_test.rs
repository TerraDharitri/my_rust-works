...
fn gov_propose_test() {
    ...
    gov_setup
        .b_mock
        .set_dcdt_balance(&first_user_addr, MOA_TOKEN_ID, &min_fee);
...
fn gov_propose_total_energy_0_test() {
    ...
    gov_setup
        .b_mock
        .set_dcdt_balance(&no_energy_user, MOA_TOKEN_ID, &min_fee);
...
fn gov_withdraw_defeated_proposal_test() {
    ...
    gov_setup
        .b_mock
        .check_dcdt_balance(&first_user_addr, MOA_TOKEN_ID, &rust_biguint!(0));
    ...
    gov_setup
        .b_mock
        .check_dcdt_balance(&first_user_addr, MOA_TOKEN_ID, &min_fee);
}
...
fn gov_withdraw_no_with_veto_defeated_proposal_test() {
    ...
    gov_setup
        .b_mock
        .check_dcdt_balance(&first_user_addr, MOA_TOKEN_ID, &(&min_fee / 2u64));
...
fn gov_propose_cancel_proposal_id_test() {
    ...
    gov_setup
        .b_mock
        .set_dcdt_balance(&first_user_addr, MOA_TOKEN_ID, &(&min_fee * 3u64));
