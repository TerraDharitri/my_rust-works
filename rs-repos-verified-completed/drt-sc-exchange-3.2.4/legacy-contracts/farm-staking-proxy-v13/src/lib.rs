...
pub type UnstakeResult<Api> = MultiValueEncoded<Api, DcdtTokenPayment<Api>>;
    ...
    + token_merge_helper::TokenMergeHelperModule
{
    ...
    fn send_unstake_payments(
        ...
        other_token_payment: DcdtTokenPayment<Self::Api>,
        lp_farm_rewards: DcdtTokenPayment<Self::Api>,
        staking_rewards: DcdtTokenPayment<Self::Api>,
        unbond_staking_farm_token: DcdtTokenPayment<Self::Api>,
    ) -> UnstakeResult<Self::Api> {
