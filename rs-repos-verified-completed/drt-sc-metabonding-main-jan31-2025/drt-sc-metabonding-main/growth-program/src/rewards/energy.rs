...
pub const ENERGY_FOUR_YEARS_MOA: u64 = 4 * 360;
pub const MOA_AMOUNT_FOR_APR_MATH: u64 = 10_000_000_000;
    ...
    + energy_query::EnergyQueryModule
{
    ...
    // Here the base investment for this APR is MOA locked for 4 years.
    #[only_owner]
    ...
    fn get_initial_rdpe(&self) -> BigUint {
        let moa_amount = BigUint::from(MOA_AMOUNT_FOR_APR_MATH) * PRECISION;
