...
fn claim_ok_first_week_unlocked_test() {
    ...
    setup
        ...
        .execute_query(&setup.gp_wrapper, |sc| {
            ...
            assert_eq!(
                total_energy,
                dharitri_sc::types::BigUint::from(57600000000002995200000000191692u128)
            );

            let interested_energy = sc.interested_energy_rewards_claimers(1, 2).get();
            assert_eq!(
                interested_energy,
                dharitri_sc::types::BigUint::from(348000 * 1000000000000000000u128 / 4)
            );
...
fn claim_ok_first_week_locked_test() {
    ...
    setup
        ...
        .execute_query(&setup.gp_wrapper, |sc| {
            ...
            assert_eq!(
                interested_energy,
                dharitri_sc::types::BigUint::from(348000 * 1000000000000000000u128 / 2)
        ...
        .execute_tx(
            ...
            |sc| {
                ...
                let _ = sc.claim_rewards(
                    1,
                    dharitri_sc::types::BigUint::from(870000078300007047000634u128) + 1u32,
...
fn claim_attempts_test() {
    ...
    setup
        ...
        .execute_query(&setup.gp_wrapper, |sc| {
            ...
            assert_eq!(
                interested_energy,
                dharitri_sc::types::BigUint::from(348000 * 1000000000000000000u128) / 2u32
            ); // 50% for one week lock
        })
        .assert_ok();
