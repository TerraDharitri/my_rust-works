    ...
    MetabondingObjBuilder: 'static + Copy + Fn() -> metabonding::ContractObj<DebugApi>,
{
    ...
    pub fn get_project_by_id(&mut self, proj_id: &[u8]) -> (Vec<u8>, u64, u64, Week, Week) {
        ...
        let mut lkmoa_rewards_supply = 0;
        ...
        self.b_mock
            .execute_query(&self.mb_wrapper, |sc| {
                ...
                lkmoa_rewards_supply = third.to_u64().unwrap();
                start_week = fourth;
                duration = fifth;
            })
            .assert_ok();
        ...
        self.b_mock.execute_tx(
            ...
            |sc| {
                sc.add_rewards_checkpoint(
                    ...
                    managed_biguint!(total_lkmoa_staked),
                );
            },
        )
    }
            ...
            .execute_tx(caller, &self.mb_wrapper, &rust_biguint!(0), |sc| {
                ...
                args.push(
                    (
                        ...
                        managed_biguint!(user_lkmoa_staked),
                        signature.into(),
                    )
                        .into(),
                );
    ...
    pub fn call_claim_rewards_multiple(
        ...
        self.b_mock
            .execute_tx(caller, &self.mb_wrapper, &rust_biguint!(0), |sc| {
                ...
                for arg in args {
                    let (week, user_delegation_supply, user_lkmoa_staked, signature) = *arg;
        ...
        self.b_mock
            .execute_query(&self.mb_wrapper, |sc| {
                let result = sc.get_rewards_for_week_pretty(
                    ...
                    managed_biguint!(user_lkmoa_staked_amount),
                );
