    ...
    Gas: TxGas<Env>,
{
    ...
    pub fn get_current_tx_batch(
        self,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, OptionalValue<MultiValue2<u64, MultiValueEncoded<Env::Api, MultiValue7<u64, u64, ManagedAddress<Env::Api>, ManagedAddress<Env::Api>, ManagedVec<Env::Api, DcdtTokenPayment<Env::Api>>, ManagedVec<Env::Api, DcdtTokenData<Env::Api>>, Option<transaction::TransferData<Env::Api>>>>>>> {
        self.wrapped_tx
            .payment(NotPayable)
