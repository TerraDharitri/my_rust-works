...
// where
//     BridgeBuilder: 'static + Copy + Fn() -> dcdt_safe::ContractObj<DebugApi>,
...
//     pub bridge_wrapper: ContractObjWrapper<dcdt_safe::ContractObj<DebugApi>, BridgeBuilder>,
...
//
//         b_mock.set_dcdt_balance(&user, FUNGIBLE_TOKEN_ID, &rust_biguint!(TOKEN_BALANCE));
//         b_mock.set_dcdt_balance(&user, FEE_TOKEN_ID, &rust_biguint!(TOKEN_BALANCE));
