...
use ping_pong_interact::{Config, PingPongInteract, REWA};
...
async fn test_ping_pong_cs() {
    ...
    interactor.deploy(amount, time, REWA.to_string()).await;
