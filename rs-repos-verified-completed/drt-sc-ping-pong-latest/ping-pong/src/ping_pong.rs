...
pub trait PingPong {
    ...
    /// `token_id` - Optional. The Token Identifier of the token that is going to be used. Default is "REWA".
    #[init]
    fn init(
        &self,
        ping_amount: BigUint,
        duration_in_seconds: u64,
        opt_token_id: OptionalValue<RewaOrDcdtTokenIdentifier>,
    ) {
    ...
    fn accepted_payment_token_id(&self) -> SingleValueMapper<RewaOrDcdtTokenIdentifier>;
