import { createAirdropService, FiveMinutesInMilliseconds, INetworkProvider, ITestSession, ITestUser, TestSession } from "@numbatnetwork/drtjs-snippets";
import { TokenPayment } from "@numbatnetwork/drtjs";
