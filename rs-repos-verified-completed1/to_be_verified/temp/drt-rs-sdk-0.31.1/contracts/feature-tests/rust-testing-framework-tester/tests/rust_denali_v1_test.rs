...
use numbat_wasm::{
    numbat_codec::Empty,
    types::{Address, BigUint, DcdtLocalRole, DcdtTokenPayment, DcdtTokenType, ManagedVec},
};
...
const TEST_DCDT_OUTPUT_PATH: &'static str = "test_dcdt_generation.scen.json";
...
fn test_back_and_forth_transfers() {
    ...
    wrapper
        .execute_dcdt_multi_transfer(&user, &forwarder_wrapper, &transfers, |sc| {
            ...
            managed_payments.push(DcdtTokenPayment {
